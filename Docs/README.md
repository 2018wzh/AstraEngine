...
| [samples/astra-rpg-ai-town/README.md](samples/astra-rpg-ai-town/README.md) | AstraRPG AI Town 20 NPC headless planned sample |
| [samples/astra-rpg-cp2020-local-adapter/README.md](samples/astra-rpg-cp2020-local-adapter/README.md) | CP2020 local-private adapter planned sample |
