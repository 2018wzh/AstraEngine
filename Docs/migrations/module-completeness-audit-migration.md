...
**2026-07-13 历史修补记录：** 当时的 Runtime world/save 为 v2。该证据已被 2026-07 Runtime v3 迁移取代，不能继续作为当前完成证据。当前主路径只接受 `astra.runtime.save_blob.v3`；transaction、history 与并行一致性证据完成前保持 `IN_PROGRESS`。
