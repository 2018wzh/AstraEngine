...
- `astra-platform-general` 提供资源表、有序 completion、atomic save transaction、hash-bound package range reader、共享 `WgpuPresentationCore`、lock-free native audio queue、typed gamepad mapper 与 native verified package cache。
