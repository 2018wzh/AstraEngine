...
参考仓库用于检查 AstraEMU Family 的 probe、archive reader、script VM、原生 API、媒体、系统页与原生存档行为。接入采用 [独立 Host 边界](../migrations/astraemu-independent-host.md)，不重建旧 RuntimeWorld facade。
