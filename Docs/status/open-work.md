...
- Migration 12 已进入最终验收。Yakui adapter、UI Blueprint/Controller、`CompiledVnProject`、component ABI、Classic/Modern 页面和 Headless E2 已落地；剩余工作是全 workspace gate、Windows/Web E3、性能/无障碍/component 正式 evidence 与最终 review。
