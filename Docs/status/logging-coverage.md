...
当前覆盖 EngineCore/Runtime/Plugin、Asset/Package/Cook/Release、Media/Platform、AstraVN/Player 以及 developer/fixture 链路。AstraEMU 正在迁移到独立 Manager/FVP/translation 路径；旧 CLI、package、evidence 和 E3 程序已删除，旧事件列表不再代表当前 Host 覆盖。新 Host 只记录生命周期、状态、计数与稳定 diagnostic，不记录游戏正文、翻译正文、secret、payload 或本地绝对路径。
