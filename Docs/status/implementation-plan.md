...
> 当前身份修正：上表 Stage 5 长段中的 family ABI v5/v6/v7、signed dynamic v5/v6/v7 与 snapshot v5/v6 只描述迁移前历史 evidence，不能代表当前可加载 contract。当前实现仅接受 family ABI v8；runtime snapshot 使用独立的 v7 schema。正式结论以下方 hot-path 重构记录和最终 clean Release 复跑为准。
