...
> 当前身份修正：上表 Stage 5 长段中的 family ABI v5/v6/v7、对应 signed dynamic 与 snapshot 只描述迁移前历史 evidence，不能代表当前可加载 contract。当前实现仅接受 family ABI v8 与 snapshot v8；正式结论以 v8 的 clean Release 重跑为准。
