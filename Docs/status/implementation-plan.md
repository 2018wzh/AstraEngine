...
2026-08-28 cache second-run: 同一授权八包 profile 连续执行两次 `astra-emu-cli vfs ... verify`，两次均为 8 source、14,502 entry、43,818 range read、6,624,958,365 decoded bytes，aggregate hash 保持 `sha256:e641854399512fea4182ebc7de845436d37d3eaef0b31d748b41c8bd23f9e64b`；cache hit 从 29,648 提升到 43,594。真实跨运行 cache second-run 已关闭，identity 漂移、损坏恢复和配额淘汰继续由独立 gate 约束。
