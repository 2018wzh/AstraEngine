...
| 21 | `S5-FAMILY-01` + `S5-FVP-01` + `S5-MANAGER-01` + `S5-MANAGER-UI-01` + `S5-AUTOPROBE-01` + `S5-METADATA-01` + `S5-TEXT-01` + `S5-FILTER-01` + `S5-GATE-01` | `IN_PROGRESS` | 按 [独立 Host 方案](../migrations/astraemu-independent-host.md) 实现；FVP 不提供翻译，其他 Family 暂不接入 |
