...
| 11 | `S4-AI-01` 到 `S4-GATE-01` AI/MCP closure，包括 `S4-AI-ONNX` | `SPEC_READY` | Runtime Director、provider profile、ONNX ModelBundle、Pack/VFS/encryption 复用、memory、Context Pack、AI Control 和 release gate 需要一起落地 |
