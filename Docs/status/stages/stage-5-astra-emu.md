...
同一迁移已 rebase 到 `289b89f74a972f92f98bbd481f8b45b23d969200`：filter graph 通过 ABI-owned typed DTO 进入 Product live layer，不再使用 string/hash binding。RFVP fork 更新到 `f4f64a5bb726c1759350a666a35e0a454b810f61`，局部 check 通过；Stage 证据等级不变。
