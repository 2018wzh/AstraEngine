...
本目录把路线图拆成可执行工作项。Stage 1 已实现；Stage 2-5 仍记录未实现目标、步骤和验收证据。
...
| [stage-5-astra-emu.md](stage-5-astra-emu.md) | AstraEMU Manager、engine-native family plugin 和 local case report |
