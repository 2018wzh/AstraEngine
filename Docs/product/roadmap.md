...
| Stage 4 Editor + AI/MCP | Qt/QML editor、Editor target、PIE、Inspector、Debugger、Package panel、Plugin Manager、Runtime AI、Editor Copilot、Content Generation 和 audit。 | Project Wizard 到 Package/Release Gate 闭环可用，Editor target 隔离、插件启用诊断、Trusted session、Review Queue、provider-free replay 和 audit gate 通过。 | [stage-4-editor-ai-mcp](../status/stages/stage-4-editor-ai-mcp.md) |
