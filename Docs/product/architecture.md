...
| AstraEMU | 独立 Slint Manager、薄 Family API、FVP/Musica、自主核心和可选 SDK |
...
EMU Family 自持原引擎 VM、文件与存档，Host 只管理配置、输入、窗口、CPU 最终帧、PCM 与可选文本服务。FVP 保持成熟 RFVP，小型薄适配；Musica 使用可选 SDK。动态核心驻留至进程退出，移动端编译入应用。
