...
上游基线固定为 RFVP 0.6.0 revision `304e773387a9920c9db091ec1fd937c717aea949`。
当前 hosted 适配来自已发布的
...
`73d3b4413c95a3923cce695d98c3d9bf5b08ccf0`。旧接口审阅见 [RFVP fork audit](rfvp-fork-audit.md)。
独立 adapter 正在实现，当前进度与待测游戏流程见 [实施状态](../../status/implementation-plan.md)。
