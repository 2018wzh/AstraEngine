...
本页保留为旧设计记录，不能作为当前 Family ABI 的实现声明。当前边界见 [独立 Host 重构](../../migrations/astraemu-independent-host.md)。下文的 RuntimeWorld、snapshot、text capture、Host VFS 和 opaque save envelope 均不属于新接口。
