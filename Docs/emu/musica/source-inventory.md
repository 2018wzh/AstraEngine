# Musica Source Inventory

## 本地样本

| 路径 | 用途 |
| --- | --- |
| `<musica-case-root>` | 当前 Musica game case |
| 历史 Musica 工具参考 | 历史翻译/封包工具参考，只提炼格式事实 |
...
日文原版通过 `astra.emu.musica.locale.ja-jp.cp932.v1` 做严格 CP932 转区绑定；该 hook
