...
| headless | `headless.preflight` | Migration 11 planned run/review/preflight reports | Headless blocked, missing required PNG/WAV or model review, build/package/input/scenario/target/content identity mismatch | run/review/link report hash、Headless/native session id、identity hashes；E2 only |
