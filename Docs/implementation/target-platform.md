...
Linux factory 已进入 `IN_PROGRESS`，普通 probe 仍只返回 declared profile 并要求 live conformance，不能生成伪 availability；macOS、iOS、Android factory 继续返回 `PLATFORM_NOT_IMPLEMENTED`。
