...
| `Emulator/Source/` | Stage 5 `IN_PROGRESS` | 已接入 family ABI v2、FVP/rfvp 派生 core、`AstraEmuRuntimeProvider`、RuntimeWorld bridge、SQLite Library v5、auto probe、Trusted Luau、ECNU translation、host audio/movie、Slint Manager、共享 wgpu host、签名工具、evidence encoder、Android package 和 iOS static-registry scaffold；正式平台签名与 E3 仍开放 |
