...
| --- | --- | --- | --- |
| `S2-WINDOWS-HOST-01` | Windows | `IN_PROGRESS` | winit real window、shared hardware wgpu present/readback、DPI/IME/input、WGI gamepad、WASAPI callback meter、WMF、Saved Games transaction、rfd user-authorized source 和 streaming HTTPS verified cache 已接入；剩余 cache lease/LRU、Player 接线与正式 conformance |
