...
| --- | --- | --- | --- |
| `S2-WINDOWS-HOST-01` | Windows | `IN_PROGRESS` | winit real window、hardware wgpu present/readback、DPI/IME/input、XInput button、WASAPI callback meter、WMF、Saved Games transaction 和 hash-bound package range 已接入；剩余用户文件/HTTPS/gamepad axis/Player 接线与正式 conformance |
