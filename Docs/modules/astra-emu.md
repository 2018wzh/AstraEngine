...
Manager 负责窗口、输入、配置、family 选择、provider selection、插件分发、报告、overlay、文本管线和滤镜 preset。Manager 创建并驱动 AstraEngine `RuntimeWorld`，legacy family 以 in-process plugin/provider 接入。
