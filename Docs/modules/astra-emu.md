...
| 顺序 | Family | 参考 |
| --- | --- | --- |
| 1 | KrKr/KAG/TJS | 常见 XP3/KAG/TJS 生态 |
| 2 | Artemis | system script、tag executor、现代商业 VN case |
...
EMU 提供 capability sandbox、read-only mount、archive reader、index mapper、decode helper、diagnostics 和 report API。用户 Lua 描述补丁和解码流程；EMU 不内置商业绕过逻辑。
