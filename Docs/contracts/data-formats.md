...
| `astra.performance_report.v1` | `IN_PROGRESS` | bounded recorder 生成 source/package/build/session-bound min/p50/p95/p99/max、sample count 和 diagnostic；Windows native media 已接入，正式 Player/release same-run consumer 尚未闭合 |
