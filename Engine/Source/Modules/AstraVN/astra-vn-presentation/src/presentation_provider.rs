...
impl VnPresentationProviderManifest {
    pub fn standard() -> Self {
        let preset_ids = vec![
            ...
            "crossfade".to_string(),
            "director_puppet_1".to_string(),
            "director_puppet_9".to_string(),
            "director_puppet_10".to_string(),
            "director_puppet_26".to_string(),
        ...
        Self {
            ...
            presets: vec![
                ...
                VnPresentationPreset {
                    id: "director_puppet_1".to_string(),
                    command_kinds: vec!["transition".to_string()],
                    duration_ms: 250,
                    easing: VnPresentationEasing::Linear,
                    filter: None,
                    fallback_policy_id: None,
                    budget_us: 4_000,
                },
                VnPresentationPreset {
                    id: "director_puppet_9".to_string(),
                    command_kinds: vec!["transition".to_string()],
                    duration_ms: 250,
                    easing: VnPresentationEasing::Linear,
                    filter: None,
                ...
                VnPresentationPreset {
                    id: "director_puppet_10".to_string(),
                    command_kinds: vec!["transition".to_string()],
                    duration_ms: 250,
                    easing: VnPresentationEasing::Linear,
                    filter: None,
                ...
                VnPresentationPreset {
                    id: "director_puppet_26".to_string(),
                    command_kinds: vec!["transition".to_string()],
                    duration_ms: 250,
                    easing: VnPresentationEasing::Linear,
                    filter: None,
