...
use astra_vn_core::{compile_astra_project, AstraSource, CompileAstraProjectOptions};
use astra_vn_package::{package_sections_for_project, PLAYER_LOCALE_CONFIG_SCHEMA};

pub(crate) const TEST_UI: &str = r#"
...
pub(crate) fn product_package_with_request(
    story: &str,
...
pub(crate) fn test_compile_options() -> CompileAstraProjectOptions {
...
pub(crate) fn test_controller_options(
    mut options: CompileAstraProjectOptions,
) -> CompileAstraProjectOptions {
...
pub(crate) fn test_controller_source() -> String {
    r#"
local controllers = {
...
pub(crate) fn bind_product_provider_authority(request: &mut PackageBuildRequest) {
    let specs = [
