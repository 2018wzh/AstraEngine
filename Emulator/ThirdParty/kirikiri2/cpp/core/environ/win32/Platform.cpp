...
std::string TVPGetDefaultFileDir() { return astra_save_dir_utf8(); }
#else
...
bool TVPCheckStartupArg() {
    ...
    // The hosted boot API selects the project directory directly; there is
    // no command line and no scene to restart.
    return false;
#else
    int argc;
