...
# Astra hosted: nasm 3.x (pinned by vcpkg) cannot assemble ffmpeg 3.3.9's
# hand-written assembly. Decode correctness does not depend on it; disable
# asm instead of chasing a legacy assembler.
string(APPEND OPTIONS " --disable-asm --disable-inline-asm --disable-yasm")
...
elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
    string(APPEND OPTIONS " --target-os=none --disable-asm --disable-inline-asm --disable-yasm --disable-stripping --disable-network --enable-pthreads --disable-hwaccels")
endif()
...
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
    # toolchain handled by emscripten triplet, skip MSVC-specific logic
elseif(VCPKG_DETECTED_MSVC)
