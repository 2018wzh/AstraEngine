...
use astra_emu_musica::{
    mount_musica, parse_audio_resource_spec, parse_sc, MusicaAniArchive, MusicaSqzArchive,
...
fn census(
    ...
    println!(
        ...
        serde_json::to_string(&serde_json::json!({
            "schema": "astra.emu.musica.sc_census.v3",
...
fn census_audio_resources(
    scripts: &[ScScript],
    manifest: &astra_emu_musica::ArchiveManifest,
