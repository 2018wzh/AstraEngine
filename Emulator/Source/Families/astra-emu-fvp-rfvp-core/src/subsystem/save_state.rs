...
impl SaveStateSnapshotV1 {
    pub fn capture_with_thread_manager(game_data: &mut GameData, tm: &ThreadManager) -> Self {
    ...
    pub fn apply(&self, game_data: &mut GameData, tm: &mut ThreadManager) -> Result<()> {
        ...
        bgm_player
            ...
            .context("RFVP_SNAPSHOT_BGM_RESTORE")?;

        se_player
            .apply_snapshot_v1(&self.audio.se, vfs)
            .context("RFVP_SNAPSHOT_SE_RESTORE")?;
