...
impl MinoriRuntimeError {
    /// Stable diagnostic identity, independent of display text and source operands.
    pub fn diagnostic_code(&self) -> &'static str {
        match self {
            Self::State => "ASTRA_EMU_MINORI_RUNTIME_STATE",
            Self::ProgramCounter => "ASTRA_EMU_MINORI_RUNTIME_PC",
            Self::Label => "ASTRA_EMU_MINORI_RUNTIME_LABEL",
            Self::Operand => "ASTRA_EMU_MINORI_RUNTIME_OPERAND",
            Self::UnsupportedOpcode { .. } => "ASTRA_EMU_MINORI_RUNTIME_OPCODE",
            Self::NonYieldingCycle => "ASTRA_EMU_MINORI_RUNTIME_NON_YIELDING_CYCLE",
            Self::Waiting => "ASTRA_EMU_MINORI_RUNTIME_WAIT",
            Self::Overflow => "ASTRA_EMU_MINORI_RUNTIME_OVERFLOW",
            Self::NativeSaveFormat => "ASTRA_EMU_MINORI_NATIVE_SAVE_FORMAT",
            Self::ChainTarget => "ASTRA_EMU_MINORI_RUNTIME_CHAIN",
            Self::AudioResource => "ASTRA_EMU_MINORI_RUNTIME_AUDIO_RESOURCE",
            Self::Effect => "ASTRA_EMU_MINORI_RUNTIME_EFFECT",
            Self::Panel => "ASTRA_EMU_MINORI_RUNTIME_PANEL",
        }
    }
}
