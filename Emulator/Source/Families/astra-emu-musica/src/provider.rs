...
use crate::save::{
    ...
    quick_save_file_number, slot_path, slot_temporary_path, MusicaConfigEnvelope,
    MusicaSaveEnvelope, MUSICA_CONFIG_MAX_BYTES, MUSICA_CONFIG_PATH, MUSICA_CONFIG_ROOT,
    MUSICA_CONFIG_SCHEMA, MUSICA_CONFIG_TEMPORARY_PATH, MUSICA_QUICK_SAVE_SLOT_COUNT,
    MUSICA_SAVE_COMMENT_MAX_BYTES, MUSICA_SAVE_MAX_BYTES, MUSICA_SAVE_MAX_SLOTS, MUSICA_SAVE_ROOT,
    MUSICA_SAVE_SCHEMA, MUSICA_SAVE_THUMBNAIL_HEIGHT, MUSICA_SAVE_THUMBNAIL_MAX_BYTES,
...
pub const MUSICA_FAMILY_ID: &str = "musica";
pub const MUSICA_RUNTIME_PROVIDER_ID: &str = "astra.emu.family.musica";
...
const MUSICA_TEXT_SURFACE_ID: &str = "musica.surface.text";
const MUSICA_TEXT_LAYER_ID: &str = "musica.layer.text";
const MUSICA_CONTROL_KEY: &str = "control";
const MUSICA_POINTER_X: &str = "pointer.x";
const MUSICA_POINTER_Y: &str = "pointer.y";
const MUSICA_POINTER_PRIMARY: &str = "pointer.primary";
...
const MUSICA_TITLE_MENU_LEFT: i32 = 1024;
const MUSICA_TITLE_MENU_RIGHT: i32 = 1280;
const MUSICA_TITLE_MENU_ROW_HEIGHT: i32 = 48;
const MUSICA_TITLE_MENU_ROW_TOPS_BASE: [i32; 4] = [24, 72, 120, 216];
const MUSICA_TITLE_MENU_ROW_TOPS_MEMORIES: [i32; 5] = [24, 72, 120, 168, 216];
const MUSICA_TITLE_MENU_HOVER_SCISSOR_X: i32 = 1024;
const MUSICA_GAME_MENU_PLAY_MODE_LEFT: i32 = 1125;
const MUSICA_GAME_MENU_PLAY_MODE_TOP: i32 = 577;
const MUSICA_GAME_MENU_PLAY_MODE_RIGHT: i32 = 1177;
const MUSICA_GAME_MENU_PLAY_MODE_BOTTOM: i32 = 616;
const MUSICA_CHOICE_CONFIRM_CONTROLS: [&str; 2] = ["enter", "space"];
const MUSICA_CHOICE_NAVIGATION_CONTROLS: [&str; 2] = ["arrow_up", "arrow_down"];
const MUSICA_CHOICE_RESOURCE_URIS: [&str; 3] = [
    "musica:/sys/SelectBLur.png",
    "musica:/sys/SelectFocus.png",
    "musica:/sys/SelectActive.png",
];
const MUSICA_CHOICE_TEXTURE_BASE: u32 = 500;
const MUSICA_CHARACTER_TEXTURE_BASE: u32 = 10_000;
const MUSICA_CHARACTER_REPLACEMENT_TEXTURE_BASE: u32 = 15_000;
const MUSICA_SYSTEM_TEXTURE_ID: u32 = 20_000;
const MUSICA_BACKLOG_GAUGE_TEXTURE_ID: u32 = 20_001;
const MUSICA_BACKLOG_BALL_TEXTURE_ID: u32 = 20_002;
// Save/load headings are authored against the fixed 1280x720 Musica stage.
...
const MUSICA_SAVE_LOAD_TITLE_X: i32 = 64;
const MUSICA_SAVE_LOAD_HEADER_Y: i32 = 16;
const MUSICA_SAVE_LOAD_PAGE_X: i32 = 608;
const MUSICA_CONFIG_KNOB_TEXTURE_ID: u32 = 20_010;
const MUSICA_CONFIG_CHECKMARK_TEXTURE_ID: u32 = 20_011;
const MUSICA_CONFIG_CIRCLE_TEXTURE_ID: u32 = 20_012;
const MUSICA_GALLERY_CG_THUMB_TEXTURE_BASE: u32 = 21_000;
const MUSICA_TITLE_BASE_ITEM_COUNT: u32 = 4;
const MUSICA_TITLE_MEMORIES_ITEM_COUNT: u32 = 5;
const MUSICA_MEMORIES_ITEM_COUNT: u32 = 5;
const MUSICA_GALLERY_CG_PAGE_COUNT: u32 = 12;
const MUSICA_GALLERY_BGM_TRACK_COUNT: u32 = 47;
const MUSICA_GALLERY_REPLAY_PAGE_COUNT: u32 = 4;
const MUSICA_GALLERY_MOVIE_COUNT: u32 = 4;
const MUSICA_GALLERY_CG_PAGE_URIS: [&str; 12] = [
    "musica:/sys/cgpage001.png",
    "musica:/sys/cgpage002.png",
    "musica:/sys/cgpage003.png",
    "musica:/sys/cgpage004.png",
    "musica:/sys/cgpage005.png",
    "musica:/sys/cgpage006.png",
    "musica:/sys/cgpage007.png",
    "musica:/sys/cgpage008.png",
    "musica:/sys/cgpage009.png",
    "musica:/sys/cgpage010.png",
    "musica:/sys/cgpage011.png",
    "musica:/sys/cgpage012.png",
];
const MUSICA_GALLERY_BGM_PAGE_URIS: [&str; 3] = [
    "musica:/sys/musicPage1.png",
    "musica:/sys/musicPage2.png",
    "musica:/sys/musicPage3.png",
];
const MUSICA_GALLERY_BGM_TRACK_URIS: [&str; 47] = [
    "musica:/bgm/BGM001.ogg",
    "musica:/bgm/BGM002.ogg",
    "musica:/bgm/BGM003.ogg",
    "musica:/bgm/BGM004.ogg",
    "musica:/bgm/BGM005.ogg",
    "musica:/bgm/BGM006.ogg",
    "musica:/bgm/BGM007.ogg",
    "musica:/bgm/BGM008.ogg",
    "musica:/bgm/BGM009.ogg",
    "musica:/bgm/BGM010.ogg",
    "musica:/bgm/BGM011.ogg",
    "musica:/bgm/BGM012.ogg",
    "musica:/bgm/BGM013.ogg",
    "musica:/bgm/BGM014.ogg",
    "musica:/bgm/BGM015.ogg",
    "musica:/bgm/BGM016.ogg",
    "musica:/bgm/BGM017.ogg",
    "musica:/bgm/BGM018.ogg",
    "musica:/bgm/BGM019.ogg",
    "musica:/bgm/BGM020.ogg",
    "musica:/bgm/BGM021.ogg",
    "musica:/bgm/BGM022.ogg",
    "musica:/bgm/BGM023.ogg",
    "musica:/bgm/BGM024.ogg",
    "musica:/bgm/BGM031.ogg",
    "musica:/bgm/BGM032.ogg",
    "musica:/bgm/BGM033.ogg",
    "musica:/bgm/BGM034.ogg",
    "musica:/bgm/BGM035.ogg",
    "musica:/bgm/BGM036.ogg",
    "musica:/bgm/BGM037.ogg",
    "musica:/bgm/BGM038.ogg",
    "musica:/bgm/BGM041.ogg",
    "musica:/bgm/BGM042.ogg",
    "musica:/bgm/BGM043.ogg",
    "musica:/bgm/BGM051.ogg",
    "musica:/bgm/BGM052.ogg",
    "musica:/bgm/BGM061.ogg",
    "musica:/bgm/BGM062.ogg",
    "musica:/bgm/BGM071.ogg",
    "musica:/bgm/BGM072.ogg",
    "musica:/bgm/BGM073.ogg",
    "musica:/bgm/BGM074.ogg",
    "musica:/bgm/BGM081.ogg",
    "musica:/bgm/BGM082.ogg",
    "musica:/bgm/BGM083.ogg",
    "musica:/bgm/BGM084.ogg",
];
const MUSICA_GALLERY_REPLAY_PAGE_URIS: [&str; 4] = [
    "musica:/sys/flash0.png",
    "musica:/sys/flash1.png",
    "musica:/sys/flash2.png",
    "musica:/sys/flash3.png",
];
const MUSICA_GALLERY_REPLAY_SCRIPT_TARGETS: [&str; 4] = [
    "fb_ren_04.sc",
    "fb_aya_04.sc",
    "fb_sui_04.sc",
    "fb_tou_04.sc",
];
const MUSICA_GALLERY_MOVIE_SCRIPT_TARGETS: [&str; 4] = [
    "fb_aya_12.sc",
    "fb_ren_16.sc",
    "fb_sui_12.sc",
    "fb_tou_12.sc",
];
const MUSICA_GALLERY_MOVIE_LABELS: [&str; 4] =
    ["ed_ayame.avi", "ed_ren.avi", "ed_sui.avi", "ed_tohka.avi"];
const MUSICA_GLOBAL_PROGRESS_OPTION: &str = "astra.provider.storage";
const MUSICA_WRITABLE_FILE_BINDING_ID: &str = "astra.writable_file.v1";
const MUSICA_GLOBAL_PROGRESS_DIRECTORY: &str = MUSICA_CONFIG_ROOT;
const MUSICA_GLOBAL_PROGRESS_PATH: &str = "musica/global-progress-v1.bin";
const MUSICA_GLOBAL_PROGRESS_TEMPORARY_PATH: &str = "musica/global-progress-v1.tmp";
const MAX_GLOBAL_PROGRESS_BYTES: u64 = 1024 * 1024;
const MUSICA_GLOBAL_PROGRESS_SCHEMA: &str = "astra.emu.musica.global_progress.v1";
#[allow(dead_code)]
const MUSICA_GLOBAL_PROGRESS_SNAPSHOT_SCHEMA: &str = "astra.emu.musica.global_progress_snapshot.v1";
...
impl LegacyTextPresentationV1 {
    fn validate(&self) -> Result<(), LegacyProviderError> {
        ...
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_TEXT_LAYOUT_BINDING",
                "Musica text layout requires its explicit Japanese font and visible color",
            ));
        }
        for region in self.speaker.iter().chain(std::iter::once(&self.body)) {
            ...
            {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_TEXT_LAYOUT_REGION",
                    "Musica text layout region is invalid",
                ));
            }
        }
        if self
        ...
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_TEXT_OUTLINE",
                "Musica text outline is invalid",
            ));
        }
        Ok(())
    }
...
impl SaveSlotMetadataContext {
    const fn diagnostic(self, kind: SaveSlotMetadataDiagnostic) -> &'static str {
        match (self, kind) {
            (Self::List, SaveSlotMetadataDiagnostic::Format) => "ASTRA_EMU_MUSICA_SAVE_LIST_FORMAT",
            (Self::Load, SaveSlotMetadataDiagnostic::Format) => "ASTRA_EMU_MUSICA_LOAD_SLOT_FORMAT",
            (Self::List, SaveSlotMetadataDiagnostic::Identity) => {
                "ASTRA_EMU_MUSICA_SAVE_LIST_IDENTITY"
            }
            (Self::Load, SaveSlotMetadataDiagnostic::Identity) => {
                "ASTRA_EMU_MUSICA_LOAD_SLOT_IDENTITY"
            }
            (Self::List, SaveSlotMetadataDiagnostic::Timestamp) => {
                "ASTRA_EMU_MUSICA_SAVE_LIST_TIMESTAMP"
            }
            (Self::Load, SaveSlotMetadataDiagnostic::Timestamp) => {
                "ASTRA_EMU_MUSICA_LOAD_SLOT_TIMESTAMP"
            }
            (Self::List, SaveSlotMetadataDiagnostic::Comment) => {
                "ASTRA_EMU_MUSICA_SAVE_LIST_COMMENT"
            }
            (Self::Load, SaveSlotMetadataDiagnostic::Comment) => {
                "ASTRA_EMU_MUSICA_LOAD_SLOT_COMMENT"
            }
            (Self::List, SaveSlotMetadataDiagnostic::Thumbnail) => {
                "ASTRA_EMU_MUSICA_SAVE_LIST_THUMBNAIL"
            }
            (Self::Load, SaveSlotMetadataDiagnostic::Thumbnail) => {
                "ASTRA_EMU_MUSICA_LOAD_SLOT_THUMBNAIL"
            }
        }
    }
}
...
#[serde(deny_unknown_fields)]
#[allow(dead_code)]
struct MusicaGlobalProgressSnapshotV1 {
    schema: String,
    enabled: bool,
    loaded: bool,
...
struct TestProviderCheckpoint {
    ...
    global_progress: MusicaGlobalProgressSnapshotV1,
}

#[derive(Debug, Clone)]
struct MusicaGlobalProgressSession {
    enabled: bool,
    loaded: bool,
    persisted_unlocks: Vec<Hash256>,
}
fn message_input_keys(control_fast_forward_enabled: bool) -> Vec<String> {
    MUSICA_MESSAGE_HOST_AWAIT_CONTROLS
        .iter()
        .copied()
        .chain(control_fast_forward_enabled.then_some(MUSICA_CONTROL_KEY))
        .map(str::to_owned)
        .collect()
}

fn choice_input_keys() -> Vec<String> {
    MUSICA_CHOICE_CONFIRM_CONTROLS
        .iter()
        .map(|key| key.to_string())
        .collect()
}

const MUSICA_MESSAGE_INPUT_CONTROLS: [&str; 3] = ["enter", "space", "pointer.primary"];
const MUSICA_WINDOW_CLOSE_CONTROL: &str = "window.close";
...
const MUSICA_MESSAGE_HOST_AWAIT_CONTROLS: [&str; 4] =
    ["enter", "space", "escape", "pointer.primary"];

fn musica_message_presentation(
    stage_size: Option<(u32, u32)>,
    text_shadow: bool,
) -> Result<LegacyTextPresentationV1, LegacyProviderError> {
    if stage_size != Some((1280, 720)) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_STAGE_IDENTITY",
            "the verified Musica message layout requires the 1280x720 reference stage",
        ));
    }
    let presentation = LegacyTextPresentationV1 {
        layout_id: "musica.message".into(),
        language: "ja-JP".into(),
...
fn musica_gallery_movie_presentation(
    stage_size: Option<(u32, u32)>,
) -> Result<LegacyTextPresentationV1, LegacyProviderError> {
    if stage_size != Some((1280, 720)) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_MOVIE_STAGE_IDENTITY",
            "the verified movie gallery layout requires the 1280x720 stage",
        ));
    }
    let presentation = LegacyTextPresentationV1 {
        layout_id: "musica.gallery.movie".into(),
        language: "ja-JP".into(),
        font_families: vec!["Noto Sans JP".into()],
        body: LegacyTextRegionV1 {
            x: 160,
...
struct MusicaSession {
    ...
    reported_system_page: Option<MusicaSystemPage>,
    reported_play_mode: Option<MusicaPlayMode>,
    reported_gallery_unlock_count: Option<usize>,
    reported_choice_active: Option<bool>,
    reported_progress_in_background: Option<bool>,
    global_progress: MusicaGlobalProgressSession,
    config_storage_enabled: bool,
    config_persisted: MusicaConfigState,
    ...
    save_slot_metadata: BTreeMap<u32, MusicaSaveSlotMetadata>,
    text_renderer: Option<MusicaTextSurfaceRenderer>,
    ...
    /// Per-role raster cache for resource-backed scenes.  Musica animation
    ...
    presentation_layers: BTreeMap<MusicaLayerRole, CachedMusicaLayer>,
    ...
    active_confirmation: Option<ActiveMusicaConfirmation>,
    active_system_command: Option<ActiveMusicaSystemCommand>,
    active_text_input: Option<ActiveMusicaTextInput>,
    poisoned: bool,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum MusicaConfirmationAction {
    Exit,
    ReturnTitle,
}

const MUSICA_CONFIRMATION_TITLE: &str = "確認";
const MUSICA_CONFIRMATION_ACCEPT_LABEL: &str = "是(Y)";
const MUSICA_CONFIRMATION_CANCEL_LABEL: &str = "否(N)";

fn musica_confirmation_message(action: MusicaConfirmationAction) -> &'static str {
    match action {
        MusicaConfirmationAction::Exit => "終了してもよろしいですか?",
        MusicaConfirmationAction::ReturnTitle => {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct ActiveMusicaConfirmation {
    confirmation_id: String,
    action: MusicaConfirmationAction,
}

#[derive(Debug, Clone, PartialEq, Eq)]
struct ActiveMusicaSystemCommand {
    command_id: String,
...
impl MusicaRuntimeProvider {
    ...
    fn vfs(&self) -> Result<&Arc<dyn LegacyVfsReader>, LegacyProviderError> {
        self.vfs.as_ref().ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_RUNTIME_VFS",
                "Musica runtime has no explicitly bound VFS reader",
            )
        })
    }
    ...
    fn host_services(&self) -> Result<&LegacyFamilyHostServicesV9, LegacyProviderError> {
        self.host_services.as_ref().ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_RUNTIME_HOST_SERVICES",
                "Musica runtime has no explicitly bound current Family ABI host services",
            )
        })
    }
}

pub fn create_static_musica_provider(
...
impl LegacyRuntimeProvider for MusicaRuntimeProvider {
    ...
    fn probe(
        ...
        let candidates = request
            .candidate_uris
            .iter()
            .filter(|uri| uri.starts_with("musica:/scr/") && uri.ends_with(".sc"))
            .collect::<Vec<_>>();
        let candidate = candidates
            .iter()
            .find(|uri| uri.eq_ignore_ascii_case("musica:/scr/test.sc"))
            .copied()
            .or_else(|| (candidates.len() == 1).then(|| candidates[0]))
            .ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_PROBE_ENTRY",
        ...
        Ok(LegacyProbeReport {
            ...
            markers: if marker_match {
                vec!["musica.sc.cp932".into(), "musica.sc.command_stream".into()]
            } else {
                Vec::new()
            },
            blockers: Vec::new(),
    ...
    fn open(
        ...
        tracing::debug!(
            ...
            event = "astra_emu_musica_launch_profile_received",
        ...
        if title_launch {
            ...
            tracing::debug!(
                ...
                event = "astra_emu_musica_title_session_initialized",
        ...
        let stage_size = match (
            ...
            (Some(width), Some(height)) => {
                let width = width.parse::<u32>().map_err(|_| {
                    invalid("ASTRA_EMU_MUSICA_STAGE_SIZE", "stage width is invalid")
                })?;
                let height = height.parse::<u32>().map_err(|_| {
                    invalid("ASTRA_EMU_MUSICA_STAGE_SIZE", "stage height is invalid")
                })?;
                if !(320..=8192).contains(&width) || !(240..=8192).contains(&height) {
                    return Err(invalid(
                        "ASTRA_EMU_MUSICA_STAGE_SIZE",
            ...
            .map(String::as_str)
        {
            ...
            Some(_) => {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_TRACE_PROFILE",
        ...
        {
            None => false,
            Some(MUSICA_WRITABLE_FILE_BINDING_ID) => true,
            Some(_) => {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_PROVIDER",
...
fn profile_fingerprint(
    ...
    let bytes = postcard::to_allocvec(&identity).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_SAVE_PROFILE_IDENTITY",
            "Musica profile identity could not be encoded",
        )
    })?;
...
impl MusicaRuntimeProvider {
    ...
    fn step_staged(
            ...
            .is_none_or(|expected| input.tick_index != expected)
        {
            ...
            return Err(runtime_error(MusicaRuntimeError::State));
        }
        ...
        for edge in &input.input_edges {
            if edge.control == MUSICA_CONTROL_KEY {
                session.vm.set_control_pressed(edge.pressed);
            } else if edge.control == MUSICA_POINTER_X {
                session
                    .vm
                    .set_pointer_axis('x', edge.value)
                    .map_err(runtime_error)?;
            } else if edge.control == MUSICA_POINTER_Y {
                session
                    .vm
                    .set_pointer_axis('y', edge.value)
                    .map_err(runtime_error)?;
            } else if edge.control == MUSICA_POINTER_PRIMARY {
                session.vm.set_pointer_primary_pressed(edge.pressed);
            }
        }
        if session.vm.state().system_ui.page == MusicaSystemPage::Title {
            let pointer_axis = input
                .input_edges
                .iter()
                .any(|edge| matches!(edge.control.as_str(), MUSICA_POINTER_X | MUSICA_POINTER_Y));
            let pointer_primary = input
                .input_edges
                .iter()
                .any(|edge| edge.control == MUSICA_POINTER_PRIMARY && edge.pressed);
        ...
        if !input.provider_results.is_empty() {
            session.poisoned = true;
            return Err(invalid(
                "ASTRA_EMU_MUSICA_PROVIDER_RESULT_REMOVED",
                "current Family ABI Musica does not accept provider-result payloads",
            ));
        }
        ...
        let window_close_requested = input
            .input_edges
            .iter()
            .any(|edge| edge.pressed && edge.control == MUSICA_WINDOW_CLOSE_CONTROL);
        if window_close_requested {
                ...
                || !input.provider_results.is_empty()
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_WINDOW_CLOSE_INPUT_AMBIGUOUS",
            ...
            let sequence = session
                ...
                .map_err(runtime_error)?;
            let confirmation_id = format!("musica.confirmation.window_close.{sequence}");
            services.confirmations.publish(
                &session_id.0,
                LegacyConfirmationTransactionV1 {
                    sequence,
                    confirmation_id: confirmation_id.clone(),
                    // These strings are the native Musica close-dialog
                    ...
                    title: MUSICA_CONFIRMATION_TITLE.into(),
                    message: musica_confirmation_message(MusicaConfirmationAction::Exit).into(),
                    accept_label: MUSICA_CONFIRMATION_ACCEPT_LABEL.into(),
                    cancel_label: MUSICA_CONFIRMATION_CANCEL_LABEL.into(),
                },
            )?;
            session.active_confirmation = Some(ActiveMusicaConfirmation {
                confirmation_id,
                action: MusicaConfirmationAction::Exit,
            });
            session
                .vm
                .advance_provider_tick(input.tick_index)
                .map_err(runtime_error)?;
            return if session.vm.state().system_ui.page == MusicaSystemPage::None {
        ...
        if session.active_system_menu.is_some() {
                ...
                || !input.provider_results.is_empty()
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_MENU_INPUT_WHILE_ACTIVE",
        ...
        if session.vm.state().system_ui.page == MusicaSystemPage::None
            ...
            && !session.vm.state().backlog.is_empty()
        {
            if !input.await_results.is_empty() || !input.provider_results.is_empty() {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_BACKLOG_RESULT_UNEXPECTED",
        ...
        if save_menu_pressed && session.vm.state().system_ui.page == MusicaSystemPage::None {
                ...
                || !input.provider_results.is_empty()
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SAVE_INPUT_AMBIGUOUS",
            ...
            match session.vm.state().wait.as_ref() {
                Some(
                    MusicaWaitState::Input { .. }
                    | MusicaWaitState::Time { .. }
                    | MusicaWaitState::Voice { .. },
                ) => {}
                Some(MusicaWaitState::Choice { .. }) => {
                    session.poisoned = true;
                    return Err(invalid(
                        "ASTRA_EMU_MUSICA_SAVE_CHOICE_ACTIVE",
                        "save menu cannot open while a choice is active",
                    ));
                }
                Some(MusicaWaitState::Media { .. }) => {
                    session.poisoned = true;
                    return Err(invalid(
                        "ASTRA_EMU_MUSICA_SAVE_MEDIA_ACTIVE",
                        "save menu cannot open while a movie is active",
                    ));
                }
                Some(MusicaWaitState::AxisScroll { .. })
                | Some(MusicaWaitState::LinearScroll { .. })
                | Some(MusicaWaitState::CharacterTransition { .. })
                | Some(MusicaWaitState::Presentation { .. })
                | Some(MusicaWaitState::Provider { .. })
                | None => {
                    session.poisoned = true;
                    return Err(invalid(
                        "ASTRA_EMU_MUSICA_SAVE_WAIT_STATE",
        ...
        if session.vm.state().system_ui.page != MusicaSystemPage::None {
                ...
                && input.await_results.len() == 1
            {
                let token_id = wait_token(
                    session
                        ...
                        .wait
                        .as_ref()
                        .ok_or_else(|| runtime_error(MusicaRuntimeError::Backlog))?,
                );
                ...
                || !input.provider_results.is_empty()
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_RESULT_UNEXPECTED",
            ...
            let title_start = session.vm.state().system_ui.page == MusicaSystemPage::Title;
            ...
            if backlog_replay_completion {
                action = MusicaSystemUiAction::ReplayBacklogVoice;
            }
            tracing::debug!(
                target: "astra_emu_musica::system_ui",
                event = "astra_emu_musica_system_ui_input_applied",
            ...
            if let MusicaSystemUiAction::GalleryReplayStart(_)
            | MusicaSystemUiAction::GalleryMovieStart(_) = action
            {
                let (target, page) = match action {
                    MusicaSystemUiAction::GalleryReplayStart(index) => (
                        MUSICA_GALLERY_REPLAY_SCRIPT_TARGETS
                            .get(usize::try_from(index).map_err(|_| {
                                invalid(
                                    "ASTRA_EMU_MUSICA_GALLERY_REPLAY_FOCUS",
                    ...
                    MusicaSystemUiAction::GalleryMovieStart(index) => (
                        MUSICA_GALLERY_MOVIE_SCRIPT_TARGETS
                            .get(usize::try_from(index).map_err(|_| {
                                invalid(
                                    "ASTRA_EMU_MUSICA_GALLERY_MOVIE_FOCUS",
                ...
                tracing::info!(
                    target: "astra_emu_musica::system_ui",
                    event = "astra_emu_musica_gallery_script_started",
            ...
            if action == MusicaSystemUiAction::StartGame && title_start {
                ...
                tracing::debug!(
                    target: "astra_emu_musica::runtime",
                    event = "astra_emu_musica_title_entry_reloaded",
            ...
            if action != MusicaSystemUiAction::StartGame {
                if let MusicaSystemUiAction::SaveSlot(slot) = action {
                    let services = host_services.as_ref().ok_or_else(|| {
                        invalid(
                            "ASTRA_EMU_MUSICA_RUNTIME_HOST_SERVICES",
                    ...
                    let sequence = session
                        ...
                        .allocate_effect_sequence()
                        .map_err(runtime_error)?;
                    let prompt_id = format!("musica.text_input.save_comment.{slot}.{sequence}");
                    let text_input = LegacyTextInputTransactionV1 {
                        ...
                        max_bytes: MUSICA_SAVE_COMMENT_MAX_BYTES as u32,
                    };
                    services
                        .text_inputs
                        .publish(&session_id.0, text_input.clone())?;
                    session.active_text_input = Some(ActiveMusicaTextInput {
                        prompt_id,
                        slot,
                ...
                if let MusicaSystemUiAction::LoadSlot(slot) = action {
                    load_slot(
                        host_services
                            .as_ref()
                            .ok_or_else(|| {
                ...
                if action == MusicaSystemUiAction::CloseGameplaySystemPage {
                    session
                        .vm
                        .advance_system_tick(input.tick_index)
                        .map_err(runtime_error)?;
                ...
                let commands = match action {
                    MusicaSystemUiAction::ReplayBacklogVoice => {
                        session.vm.replay_backlog_voice().map_err(runtime_error)?
                    }
                    MusicaSystemUiAction::PresentWithAudioRefresh => session
                        .vm
                        .config_audio_param_commands()
                        .map_err(runtime_error)?,
                    MusicaSystemUiAction::PresentAfterConfigClose { .. } => session
                        .vm
                        .close_config_audio_commands()
                        .map_err(runtime_error)?,
                    MusicaSystemUiAction::PresentWithAudioTest(bus) => session
                        .vm
                        .config_test_audio_commands(bus)
                        .map_err(runtime_error)?,
                    MusicaSystemUiAction::GalleryBgmPlay => {
                    ...
                    MusicaSystemUiAction::GalleryBgmStop => {
                ...
                if let MusicaSystemUiAction::PresentAfterConfigClose { fullscreen } = action {
                    if let Some(enabled) = fullscreen {
                        let sequence = session
                            ...
                            .map_err(runtime_error)?;
                        let command_id =
                            format!("musica.system_command.config_fullscreen.{sequence}");
                        ...
                        session.active_system_command = Some(ActiveMusicaSystemCommand {
                            command_id,
                            command,
                ...
                session
                    ...
                    .advance_system_tick(input.tick_index)
                    .map_err(runtime_error)?;
                if action == MusicaSystemUiAction::CloseBacklog {
                    session.vm.close_backlog().map_err(runtime_error)?;
                    return gameplay_resume_output(session, &vfs, &input, restore_audio);
                }
                if action == MusicaSystemUiAction::Exit {
                    session
                        .vm
        ...
        let game_menu_mode_pressed = input.input_edges.iter().any(|edge| {
            edge.control == MUSICA_POINTER_PRIMARY
                && edge.pressed
                && (MUSICA_GAME_MENU_PLAY_MODE_LEFT..MUSICA_GAME_MENU_PLAY_MODE_RIGHT)
                    .contains(&session.vm.state().system_ui.pointer_x)
                && (MUSICA_GAME_MENU_PLAY_MODE_TOP..MUSICA_GAME_MENU_PLAY_MODE_BOTTOM)
        ...
        if game_menu_mode_pressed {
            if !input.provider_results.is_empty() || input.await_results.len() > 1 {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_PLAY_MODE_RESULT_UNEXPECTED",
        ...
        if let Some(MusicaWaitState::Choice { token_id }) = session.vm.state().wait.clone() {
            ...
            if confirm_pressed && !input.await_results.is_empty() {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_CHOICE_DUPLICATE_COMPLETION",
        ...
        if let Some(MusicaWaitState::Input { token_id } | MusicaWaitState::Voice { token_id, .. }) =
            session
                .vm
                .state()
                .wait
                ...
                .filter(|_| !game_menu_mode_pressed)
        {
            if !input.await_results.is_empty()
                && input.input_edges.iter().any(|edge| {
                    edge.pressed
                        && MUSICA_MESSAGE_INPUT_CONTROLS
                            .iter()
                            .any(|control| *control == edge.control)
                        // The Manager deliberately retains Musica primary
                        ...
                        && (edge.control != MUSICA_POINTER_PRIMARY || game_menu_mode_pressed)
                })
            {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_INPUT_DUPLICATE_COMPLETION",
        ...
        if !input.provider_results.is_empty() {
            let Some(MusicaWaitState::Provider {
                token_id,
                request_id,
            }) = session.vm.state().wait.clone()
            else {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_PROVIDER_RESULT_UNEXPECTED",
            ...
            {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_PROVIDER_RESULT_MISMATCH",
        ...
        {
            if let Some(wait @ MusicaWaitState::Input { .. }) = session.vm.state().wait.clone() {
                ...
                // fail closed with ASTRA_EMU_MUSICA_RUNTIME_STATE.
                session
                    .vm
        ...
        if let Some(wait) = session.vm.state().wait.clone() {
            if input.await_results.is_empty() {
                let movie_to_skip = match &wait {
                    MusicaWaitState::Media { media_id, .. }
            ...
            if input.await_results.len() != 1 {
                tracing::error!(
                    target: "astra_emu_musica::runtime",
                    event = "astra_emu_musica_await_result_count_mismatch",
                ...
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_AWAIT_RESULT_COUNT",
            ...
            if result.token_id != expected {
                tracing::error!(
                    target: "astra_emu_musica::runtime",
                    event = "astra_emu_musica_await_result_token_mismatch",
                    fixed_tick = input.tick_index,
                    expected_token = %Hash256::from_sha256(expected.as_bytes()),
                ...
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_AWAIT_RESULT_TOKEN",
        ...
        let event = match session.vm.step(input.tick_index, MAX_INSTRUCTIONS_PER_STEP) {
            ...
            Err(error) => {
                ...
                if let Some(command) = command.as_ref() {
                    tracing::error!(
                        target: "astra_emu_musica::runtime",
                        event = "astra_emu_musica_command_failed",
                        ...
                        "Musica command execution failed"
                    );
                }
                session.poisoned = true;
        ...
        let chain_target = match &event {
            Some(MusicaVmEvent::Chain { target }) => Some(target.clone()),
            _ => None,
        };
        ...
        tracing::debug!(
            target: "astra_emu_musica::runtime",
            event = "astra_emu_musica_vm_tick",
            fixed_tick = input.tick_index,
            ...
            vm_event = musica_vm_event_name(event.as_ref()),
            ...
            "advanced the verified Musica VM"
        );
        if let Some((timer_ticks, milliseconds)) = event.as_ref().and_then(non_message_time_wait) {
            tracing::info!(
                target: "astra_emu_musica::runtime",
                event = "astra_emu_musica_wait_created",
                fixed_tick = input.tick_index,
                script_identity = %session.vm.state().script_hash,
                instruction_count = session.vm.state().instruction_count,
                timer_ticks,
                milliseconds,
                "created a non-message Musica time wait"
            );
        }
        if let Some(MusicaVmEvent::Message { wait, .. }) = event.as_ref() {
            let timer_ticks = match wait {
                MusicaWaitState::Time { timer_ticks, .. } => Some(*timer_ticks),
                _ => None,
            };
            tracing::info!(
                target: "astra_emu_musica::runtime",
                event = "astra_emu_musica_message_wait_created",
                fixed_tick = input.tick_index,
                script_identity = %session.vm.state().script_hash,
                instruction_count = session.vm.state().instruction_count,
                wait_kind = musica_wait_kind(wait),
                timer_ticks = timer_ticks.unwrap_or_default(),
                "created a Musica message wait"
            );
        }
        if let Some(MusicaVmEvent::Choice {
            option_hashes,
            selected_index,
            ..
        }) = event.as_ref()
        {
            tracing::info!(
                target: "astra_emu_musica::runtime",
                event = "astra_emu_musica_choice_wait_created",
                fixed_tick = input.tick_index,
                script_identity = %session.vm.state().script_hash,
                instruction_count = session.vm.state().instruction_count,
                option_count = option_hashes.len(),
                selected_index,
                "created a Musica choice wait"
            );
        }
        if matches!(
            event,
            Some(MusicaVmEvent::Chain { .. })
                | Some(MusicaVmEvent::Movie(_))
                | Some(MusicaVmEvent::Terminal)
        ) {
            tracing::info!(
                target: "astra_emu_musica::runtime",
                event = "astra_emu_musica_vm_boundary",
                fixed_tick = input.tick_index,
                script_identity = %session.vm.state().script_hash,
                pc_line = session.vm.state().pc_line,
                instruction_count = session.vm.state().instruction_count,
                ...
                system_page = system_page_name(session.vm.state().system_ui.page),
                terminal = session.vm.state().terminal,
                "reached a Musica VM control-flow boundary"
            );
        }
        ...
        let returned_to_title =
            matches!(event, Some(MusicaVmEvent::Terminal)) && !session.vm.state().terminal;
        ...
        if let Some(firefly_event) = &animated_firefly {
            let is_same_script_event = matches!(
                event,
                Some(MusicaVmEvent::Firefly(_))
                    | Some(MusicaVmEvent::FireflyCleared { .. })
                    | Some(MusicaVmEvent::AxisScroll(_))
                    | Some(MusicaVmEvent::Character(_))
            );
        ...
        if let Some(axis_scroll) = &animated_axis_scroll {
            if !matches!(event, Some(MusicaVmEvent::AxisScroll(_))) {
        ...
        if let Some(character) = &animated_character {
            if !matches!(event, Some(MusicaVmEvent::Character(_))) {
        ...
        if let Some(linear_scroll) = &animated_linear_scroll {
            if !matches!(event, Some(MusicaVmEvent::LinearScroll(_))) {
        ...
        if let Some(secondary_effect) = &animated_secondary_effect {
            if !matches!(
                event,
                Some(MusicaVmEvent::SecondaryEffect(_))
                    | Some(MusicaVmEvent::SecondaryEffectCleared { .. })
            ) {
        ...
        if let Some(screen_shake) = &animated_screen_shake {
            if !matches!(event, Some(MusicaVmEvent::ScreenShake(_))) {
        ...
        if let Some(MusicaVmEvent::Message {
            ...
            .filter(|_| !session.vm.state().system_ui.message_panel_hidden)
        {
                    ...
                    .is_some_and(|value| value.len() > MAX_EPHEMERAL_TEXT_BYTES)
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_TEXT_CAPTURE_BOUNDS",
                    "message or speaker exceeds the ephemeral text channel bound",
                ));
            }
            let lease_id = format!("musica.text.{}.{}", input.tick_index, capture_sequence);
            let presentation = LegacyTextPresentationLeaseV1 {
                lease_id: lease_id.clone(),
                presentation: match musica_message_presentation(
                    session.stage_size,
                ...
                .is_some()
            {
                session.poisoned = true;
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_TEXT_LEASE_DUPLICATE",
            ...
            live.text.push(StagedTextLease {
                ...
                source_ref: "musica.sc.message".into(),
            });
        }
        if let Some(MusicaVmEvent::Choice {
            sequence,
        ...
        if let Some(firefly_event) = &event {
            if matches!(
                firefly_event,
                MusicaVmEvent::Firefly(_) | MusicaVmEvent::FireflyCleared { .. }
            ) {
                live.resource_scenes.push(firefly_event_presentation(
                    &vfs,
                    &session.mount_set_id,
        ...
        if let Some(secondary_effect) = &event {
            if matches!(
                secondary_effect,
                MusicaVmEvent::SecondaryEffect(_) | MusicaVmEvent::SecondaryEffectCleared { .. }
            ) {
                live.resource_scenes
                    .push(secondary_effect_event_presentation(
                        &vfs,
        ...
        if let Some(MusicaVmEvent::ScreenShake(screen_shake)) = &event {
            live.resource_scenes.push(screen_shake_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::Stage(stage)) = &event {
        ...
        if let Some(MusicaVmEvent::AxisScroll(frame)) = &event {
            live.resource_scenes.push(axis_scroll_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::LinearScroll(frame)) = &event {
            live.resource_scenes.push(linear_scroll_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::ScrollXf(frame)) = &event {
            live.resource_scenes.push(scroll_xf_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::WScroll2(frame)) = &event {
            live.resource_scenes.push(wscroll2_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::Character(frame)) = &event {
            live.resource_scenes.push(character_presentation(
                &vfs,
                &session.mount_set_id,
                session.stage_size,
        ...
        if let Some(MusicaVmEvent::Effect(frame)) = &event {
        ...
        if let Some(MusicaVmEvent::Panel { sequence }) = &event {
        ...
        if let Some(MusicaVmEvent::Movie(movie)) = &event {
            tracing::info!(
                target: "astra_emu_musica::media",
                event = "astra_emu_musica_movie_requested",
        ...
        if started_game && live.resource_scenes.is_empty() {
            ...
            let (width, height) = session.stage_size.ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_STAGE_SIZE",
        ...
        let mut audio_command_count = u64::try_from(live.audio_commands.len()).map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_AUDIO_COMMAND_BOUNDS",
                ...
                if let LegacyAudioCommandV1::LoadResource { resource_uri, .. } = &command {
                    let stat = match vfs.stat_file(&session.mount_set_id, resource_uri) {
                        ...
                        Ok(_) => {
                            session.poisoned = true;
                            return Err(invalid(
                                "ASTRA_EMU_MUSICA_AUDIO_RESOURCE_BOUNDS",
                        ...
                        Err(error) => {
                            tracing::debug!(
                                target: "astra_emu_musica::resource",
                                event = "astra_emu_musica_audio_resource_stat_failed",
        ...
        let waits = match &event {
            Some(MusicaVmEvent::Wait(wait)) | Some(MusicaVmEvent::Message { wait, .. }) => {
            ...
            Some(MusicaVmEvent::Choice { .. }) => {
                let wait = session
                    ...
                    .wait
                    .as_ref()
                    .ok_or_else(|| runtime_error(MusicaRuntimeError::Choice))?;
                vec![legacy_wait(wait, session.vm.state())]
            }
            Some(MusicaVmEvent::Movie(movie)) => vec![LegacyWaitRequest::MediaFence {
        ...
        let status = match &event {
            ...
            | Some(MusicaVmEvent::Message { .. })
            | Some(MusicaVmEvent::Choice { .. }) => LegacyRuntimeStatus::Awaiting,
            Some(MusicaVmEvent::Chain { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Audio { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Stage(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::AxisScroll(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::LinearScroll(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::ScrollXf(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::WScroll2(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Character(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Effect(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::EffectCleared { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Firefly(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::FireflyCleared { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::SecondaryEffect(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::SecondaryEffectCleared { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::ScreenShake(_)) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Panel { .. }) => LegacyRuntimeStatus::Active,
            Some(MusicaVmEvent::Movie(_)) => LegacyRuntimeStatus::Awaiting,
            Some(MusicaVmEvent::Terminal) if session.vm.state().terminal => {
                LegacyRuntimeStatus::Terminal
            }
            Some(MusicaVmEvent::Terminal) => LegacyRuntimeStatus::Active,
        ...
        let trace = (after > before)
            .then(|| LegacyTraceEntry {
                ...
                opcode: "musica.sc".into(),
                action: match &event {
                    Some(MusicaVmEvent::Chain { .. }) => Some("chain".into()),
                    Some(MusicaVmEvent::Audio { .. }) => Some("audio".into()),
                    Some(MusicaVmEvent::Stage(_)) => Some("stage".into()),
                    Some(MusicaVmEvent::AxisScroll(_)) => Some("axis_scroll".into()),
                    Some(MusicaVmEvent::LinearScroll(_)) => Some("linear_scroll".into()),
                    Some(MusicaVmEvent::ScrollXf(_)) => Some("scroll_xf".into()),
                    Some(MusicaVmEvent::WScroll2(_)) => Some("wscroll2".into()),
                    Some(MusicaVmEvent::Character(_)) => Some("character".into()),
                    Some(MusicaVmEvent::Effect(_)) => Some("effect".into()),
                    Some(MusicaVmEvent::EffectCleared { .. }) => Some("effect_clear".into()),
                    Some(MusicaVmEvent::Firefly(_)) => Some("firefly".into()),
                    Some(MusicaVmEvent::FireflyCleared { .. }) => Some("firefly_clear".into()),
                    Some(MusicaVmEvent::SecondaryEffect(_)) => Some("secondary_effect".into()),
                    Some(MusicaVmEvent::SecondaryEffectCleared { .. }) => {
                        Some("secondary_effect_clear".into())
                    }
                    Some(MusicaVmEvent::ScreenShake(_)) => Some("screen_shake".into()),
                    Some(MusicaVmEvent::Panel { .. }) => Some("panel".into()),
                    Some(MusicaVmEvent::Choice { .. }) => Some("choice".into()),
                    Some(MusicaVmEvent::Movie(_)) => Some("movie".into()),
                    Some(MusicaVmEvent::Terminal) if !session.vm.state().terminal => {
        ...
        if matches!(event, Some(MusicaVmEvent::Terminal)) && !session.vm.state().terminal {
            let sequence = session
                .vm
                .allocate_effect_sequence()
                .map_err(runtime_error)?;
            output.control.blackboard.push(LegacyBlackboardMutation {
                sequence,
                key: "musica.route_complete".into(),
                value: "true".into(),
            });
        }
    ...
    fn test_checkpoint(
        ...
        Ok(TestProviderCheckpoint {
            ...
            global_progress: MusicaGlobalProgressSnapshotV1 {
                schema: MUSICA_GLOBAL_PROGRESS_SNAPSHOT_SCHEMA.into(),
    ...
    fn restore_test_checkpoint(
        ...
        let section = checkpoint.family_sections.first().ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_TEST_CHECKPOINT_SECTION",
                "test checkpoint runtime section is missing",
            )
        })?;
        if checkpoint.family_sections.len() != 1
            || section.version != SchemaVersion::new(23, 0, 0)
            || checkpoint.global_progress.schema != MUSICA_GLOBAL_PROGRESS_SNAPSHOT_SCHEMA
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_TEST_CHECKPOINT_IDENTITY",
    ...
    fn read_session_resource(
        ...
        let session = self
            ...
            .ok_or_else(session_missing)?;
        validate_session_binding(ctx, session)?;
        if max_bytes == 0 || max_bytes > MAX_RESOURCE_BYTES || !resource_uri.starts_with("musica:/")
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_RESOURCE_BOUNDS",
...
fn non_message_time_wait(event: &MusicaVmEvent) -> Option<(u32, u32)> {
    let MusicaVmEvent::Wait(wait @ MusicaWaitState::Time { token_id, .. }) = event else {
        return None;
    };
    if token_id.starts_with("musica.message.") {
        return None;
    }
    let MusicaWaitState::Time {
        timer_ticks,
        milliseconds,
        ..
    } = wait
...
fn musica_wait_kind(wait: &MusicaWaitState) -> &'static str {
    match wait {
        MusicaWaitState::Time { .. } => "time",
        MusicaWaitState::Voice { .. } => "voice",
        MusicaWaitState::AxisScroll { .. } => "axis_scroll",
        MusicaWaitState::LinearScroll { .. } => "linear_scroll",
        MusicaWaitState::CharacterTransition { .. } => "character_transition",
        MusicaWaitState::Input { .. } => "input",
        MusicaWaitState::Choice { .. } => "choice",
        MusicaWaitState::Media { .. } => "media",
        MusicaWaitState::Presentation { .. } => "presentation",
        MusicaWaitState::Provider { .. } => "provider",
    }
}
...
fn record_evidence_commands(
    session: &mut MusicaSession,
    commands: Vec<MusicaExecutedCommand>,
) -> Result<(), LegacyProviderError> {
    for command in commands {
        ...
        if let Some(existing) = session.evidence_contexts.get(&context_id) {
            if *existing != command.script_hash {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_EVIDENCE_CONTEXT_COLLISION",
        ...
        let opcode = musica_evidence_opcode(&command.opcode).ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_EVIDENCE_OPCODE",
...
fn musica_evidence_opcode(opcode: &str) -> Option<u8> {
    Some(match opcode {
        "message" => 1,
        "transition" => 2,
        "stage" => 3,
...
fn map_audio_encoding(encoding: MusicaAudioEncoding) -> LegacyAudioEncoding {
    match encoding {
        MusicaAudioEncoding::Ogg => LegacyAudioEncoding::Ogg,
        MusicaAudioEncoding::Wav => LegacyAudioEncoding::Wav,
    }
}
...
fn take_restore_audio_commands(
    ...
    for (_, state) in &active {
        if state.continuation_pts != 0 {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_MEDIA_CONTINUATION_UNSUPPORTED",
...
fn apply_scroll_xf_to_frame(
    ...
    for mut draw in frame.draws.drain(..) {
        ...
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SCROLL_XF_DRAW",
...
fn apply_wscroll2_to_frame(
    ...
    mount_set_id: &str,
    frame: &mut LegacyRenderResourceFrameV1,
    scroll: &crate::MusicaWScroll2State,
) -> Result<(), LegacyProviderError> {
    ...
    let sync_bytes = vfs
        ...
        .map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_WSCROLL2_SYNC_READ",
    ...
    for draw in frame.draws.drain(..) {
        ...
        let resource = frame
            ...
            .ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_WSCROLL2_TEXTURE",
...
fn append_wrapped_panorama_draw(
    ...
    let mut append_segment = |source_left: i64, output_left: i64, width: i64| {
        ...
        let source_right = source_left.checked_add(width).ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_WSCROLL2_BOUNDS",
...
fn append_panel_layer(
    ...
    let image_height = texture_resources
        ...
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_PANEL_RESOURCE",
    ...
    let top = i64::from(stage_height)
        ...
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_PANEL_POSITION",
...
fn visible_effect_frame(
    state: &MusicaRuntimeState,
    sequence: u64,
) -> Result<MusicaEffectFrame, LegacyProviderError> {
    let Some(effect) = &state.effect else {
        return Ok(MusicaEffectFrame {
            sequence,
...
fn axis_scroll_presentation(
    ...
    stage_size: Option<(u32, u32)>,
    state: &MusicaRuntimeState,
    axis_scroll: &MusicaAxisScrollFrame,
) -> Result<LegacySequenced<LegacyRenderResourceFrameV1>, LegacyProviderError> {
...
fn linear_scroll_presentation(
    ...
    stage_size: Option<(u32, u32)>,
    state: &MusicaRuntimeState,
    linear_scroll: &MusicaLinearScrollFrame,
) -> Result<LegacySequenced<LegacyRenderResourceFrameV1>, LegacyProviderError> {
...
fn wscroll2_presentation(
    ...
    stage_size: Option<(u32, u32)>,
    state: &MusicaRuntimeState,
    frame: &MusicaWScroll2Frame,
) -> Result<LegacySequenced<LegacyRenderResourceFrameV1>, LegacyProviderError> {
    if state.wscroll2.is_none() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_WSCROLL2_STATE",
...
fn firefly_event_presentation(
    ...
    let (sequence, frame) = match event {
        MusicaVmEvent::Firefly(frame) => (
            frame.sequence,
            describe_firefly_frame(vfs, mount_set_id, state, stage_size)?,
        ),
        MusicaVmEvent::FireflyCleared { sequence } => (
            *sequence,
            describe_effect_frame(
                vfs,
                mount_set_id,
        ...
        _ => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_FIREFLY_EVENT",
...
fn secondary_effect_event_presentation(
    ...
    let sequence = match event {
        MusicaVmEvent::SecondaryEffect(MusicaSecondaryEffectFrame { sequence })
        | MusicaVmEvent::SecondaryEffectCleared { sequence } => *sequence,
        _ => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SECONDARY_EFFECT_EVENT",
...
fn screen_shake_presentation(
    ...
    stage_size: Option<(u32, u32)>,
    state: &MusicaRuntimeState,
    frame: &MusicaScreenShakeFrame,
) -> Result<LegacySequenced<LegacyRenderResourceFrameV1>, LegacyProviderError> {
    if state.screen_shake.is_none() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SCREEN_SHAKE_STATE",
...
fn describe_firefly_frame(
    ...
    for (index, resource_uri) in firefly.resources.iter().enumerate() {
        let texture_id = 300u32
            .checked_add(u32::try_from(index).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_FIREFLY_TEXTURE_ID",
    ...
    for particle in &firefly.particles {
        ...
        if !opacity.is_finite() || !(0.0..=1.0).contains(&opacity) {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_FIREFLY_ALPHA",
...
fn append_secondary_effect_to_frame(
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SECONDARY_EFFECT_STATE",
    ...
    for (index, resource_uri) in effect.resources.iter().enumerate() {
        let texture_id = 600u32
            .checked_add(u32::try_from(index).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_SECONDARY_EFFECT_TEXTURE_ID",
    ...
    for draw in &mut frame.draws {
        for vertex in &mut draw.vertices {
            ...
            if !vertex.position[0].is_finite() || !vertex.position[1].is_finite() {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SCREEN_SHAKE_DRAW",
...
fn append_stage_contents(
    ...
    for (index, stand) in stage.stands.iter().enumerate() {
        let texture_id = 16u32
            .checked_add(u32::try_from(index).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_STAGE_LAYER_ID",
...
fn append_character_contents(
    ...
    let scissor = LegacyScissorV1 {
        ...
        width: i32::try_from(stage_width).map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_CHARACTER_BOUNDS",
    ...
    for character in characters.values().filter(|character| character.visible) {
        ...
        if let Some(replacement) = character.replacement.as_ref() {
            append_character_sprite(
                ...
                MUSICA_CHARACTER_REPLACEMENT_TEXTURE_BASE,
...
fn append_character_sprite(
    ...
    let texture_id = texture_base.checked_add(character.slot_id).ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_CHARACTER_TEXTURE_ID",
    ...
    let draw = draws.last_mut().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_CHARACTER_RESOURCE",
...
fn append_stand_layer(
    ...
    if !stand.resource_uri.to_ascii_lowercase().ends_with(".png") {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_STAGE_STAND_CODEC",
    ...
    let left = i32::try_from(left).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_STAGE_STAND_POSITION",
...
fn read_texture_resource(
    ...
    let stat = vfs
        ...
        .inspect_err(|error| {
            tracing::debug!(
                target: "astra_emu_musica::resource",
                event = "astra_emu_musica_resource_stat_failed",
                resource_identity = %Hash256::from_sha256(resource_uri.as_bytes()),
                texture_id,
                diagnostic = %error.code(),
    ...
    if stat.len == 0 || stat.len > MAX_RESOURCE_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_STAGE_IMAGE_BOUNDS",
    ...
    let bytes = vfs
        ...
        .inspect_err(|error| {
            tracing::debug!(
                target: "astra_emu_musica::resource",
                event = "astra_emu_musica_resource_read_failed",
                resource_identity = %Hash256::from_sha256(resource_uri.as_bytes()),
                texture_id,
                diagnostic = %error.code(),
    ...
    let (image_width, image_height) = match codec {
        "ani" => {
            let archive = MusicaAniArchive::parse(Arc::<[u8]>::from(bytes.as_slice()))
                .map_err(musica_image_container_error)?;
            let frame = archive.frames().first().ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_ANI_FRAME_COUNT",
        ...
        "sqz" => {
            let archive = MusicaSqzArchive::parse(Arc::<[u8]>::from(bytes.as_slice()))
                .map_err(musica_image_container_error)?;
...
fn image_codec(resource_uri: &str) -> Result<&'static str, LegacyProviderError> {
    ...
    if extension.eq_ignore_ascii_case("png") {
        ...
        Err(invalid(
            "ASTRA_EMU_MUSICA_STAGE_IMAGE_CODEC",
            "stage image extension has no explicitly bound decode codec",
        ))
    }
}

fn musica_image_container_error(error: LegacyCoreError) -> LegacyProviderError {
    LegacyProviderError::invalid(
        "ASTRA_EMU_MUSICA_IMAGE_CONTAINER",
...
fn load_script_uri(
    ...
    let source = vfs
        ...
        .inspect_err(|error| {
            tracing::debug!(
                target: "astra_emu_musica::resource",
                event = "astra_emu_musica_script_read_failed",
...
fn decode_message_voice_durations(
    ...
    for resource_uri in resources {
        ...
        let reader = BoundedByteSourceReader::new(source, 4 * 1024 * 1024).map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_MESSAGE_VOICE_READER",
        ...
        if reader.stat().len == 0 || reader.stat().len > MAX_RESOURCE_BYTES {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_MESSAGE_VOICE_BOUNDS",
        ...
        let metadata = probe_symphonia_audio_metadata_reader("ogg", reader, byte_len)
            .map_err(musica_media_decode_error)?;
        let milliseconds = metadata
            ...
            .ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_MESSAGE_VOICE_DURATION",
...
fn audit_script_resources(
    ...
    let scripts = vfs
        .enumerate_by_extension(
            ...
            "musica:/scr",
            "sc",
            MUSICA_MAX_RESOURCE_AUDIT_SCRIPTS,
        )
        .map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_RESOURCE_AUDIT_UNSUPPORTED",
                "the bound VFS cannot perform the required bounded script enumeration",
            )
        })?;
    if scripts.is_empty() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_RESOURCE_AUDIT_EMPTY",
            "the Musica script mount contains no scripts",
        ));
    }
    if scripts.len() > MUSICA_MAX_RESOURCE_AUDIT_SCRIPTS as usize {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_RESOURCE_AUDIT_BOUNDS",
            "the Musica script enumeration exceeds its bound",
        ));
    }
    ...
    for listed in scripts {
        ...
        if listed.stat.len == 0 || listed.stat.len > MAX_SCRIPT_BYTES {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_RESOURCE_AUDIT_SCRIPT_BOUNDS",
    ...
    for resource_uri in references {
        let stat = vfs.stat_file(mount_set_id, &resource_uri).map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_RESOURCE_AUDIT_MISSING",
...
fn expand_script_includes(
    ...
    for segment in source.split_inclusive(|byte| *byte == b'\n') {
        ...
        let include_uri = format!("musica:/scr/{include_target}");
        ...
        let included = vfs
            ...
            .inspect_err(|error| {
                tracing::debug!(
                    target: "astra_emu_musica::resource",
                    event = "astra_emu_musica_script_include_read_failed",
...
fn parse_include_target(line: &[u8]) -> Option<String> {
    ...
    let target = MusicaLocaleHook::japanese_cp932().decode(target).ok()?;
...
fn validate_script_uri(script_uri: &str) -> Result<(), LegacyProviderError> {
    let Some(target) = script_uri.strip_prefix("musica:/scr/") else {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SCRIPT_URI",
            "script URI is outside the Musica script mount",
        ));
    };
    if target.is_empty()
        || target.len() > 256
...
fn system_ui_action_name(action: MusicaSystemUiAction) -> &'static str {
    match action {
        MusicaSystemUiAction::Present => "present",
        MusicaSystemUiAction::PresentWithAudioRefresh => "present_with_audio_refresh",
        MusicaSystemUiAction::PresentAfterConfigClose { .. } => "present_after_config_close",
        MusicaSystemUiAction::PresentWithAudioTest(_) => "present_with_audio_test",
        MusicaSystemUiAction::StartGame => "start_game",
        MusicaSystemUiAction::CloseBacklog => "close_backlog",
        MusicaSystemUiAction::ReplayBacklogVoice => "replay_backlog_voice",
        MusicaSystemUiAction::SaveSlot(_) => "save_slot",
        MusicaSystemUiAction::LoadSlot(_) => "load_slot",
        MusicaSystemUiAction::CloseGameplaySystemPage => "close_gameplay_system_page",
        MusicaSystemUiAction::GalleryBgmPlay => "gallery_bgm_play",
        MusicaSystemUiAction::GalleryBgmStop => "gallery_bgm_stop",
        MusicaSystemUiAction::GalleryReplayStart(_) => "gallery_replay_start",
        MusicaSystemUiAction::GalleryMovieStart(_) => "gallery_movie_start",
        MusicaSystemUiAction::Exit => "exit",
    }
}

fn system_page_name(page: MusicaSystemPage) -> &'static str {
    match page {
        MusicaSystemPage::None => "none",
        MusicaSystemPage::Title => "title",
        MusicaSystemPage::Load => "load",
        MusicaSystemPage::Save => "save",
        MusicaSystemPage::Config => "config",
        MusicaSystemPage::Backlog => "backlog",
        MusicaSystemPage::Memories => "memories",
        MusicaSystemPage::GalleryCg => "gallery_cg",
        MusicaSystemPage::GalleryBgm => "gallery_bgm",
        MusicaSystemPage::GalleryReplay => "gallery_replay",
        MusicaSystemPage::GalleryMovie => "gallery_movie",
    }
}
...
fn append_system_page_observation(
...
) -> Result<Option<MusicaSystemPage>, LegacyProviderError> {
    ...
    control.blackboard.push(LegacyBlackboardMutation {
        ...
        value: (page != MusicaSystemPage::None).to_string(),
    });
    Ok(Some(page))
}

fn play_mode_name(mode: MusicaPlayMode) -> &'static str {
    match mode {
        MusicaPlayMode::Normal => "normal",
        MusicaPlayMode::Auto => "auto",
        MusicaPlayMode::Skip => "skip",
    }
}
...
fn append_play_mode_observation(
    session: &mut MusicaSession,
    control: &mut LegacyControlTransaction,
) -> Result<Option<MusicaPlayMode>, LegacyProviderError> {
...
fn append_gallery_unlock_observation(
    ...
    control.blackboard.push(LegacyBlackboardMutation {
        sequence,
        key: "musica.gallery_unlock_count".into(),
...
fn append_progress_in_background_observation(
    ...
    control.blackboard.push(LegacyBlackboardMutation {
        sequence,
        key: "musica.progress_in_background".into(),
...
fn encode_global_progress(unlocks: &[Hash256]) -> Result<Vec<u8>, LegacyProviderError> {
    let progress = MusicaGlobalProgressV1 {
        schema: MUSICA_GLOBAL_PROGRESS_SCHEMA.into(),
        gallery_unlocks: unlocks.to_vec(),
    };
    postcard::to_allocvec(&progress).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_ENCODE",
...
fn decode_global_progress(bytes: &[u8]) -> Result<Vec<Hash256>, LegacyProviderError> {
    let progress: MusicaGlobalProgressV1 = postcard::from_bytes(bytes).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_DECODE",
            "global progress payload could not be decoded",
        )
    })?;
    if progress.schema != MUSICA_GLOBAL_PROGRESS_SCHEMA {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_SCHEMA",
...
fn load_global_progress(
    ...
    if !session.global_progress.enabled || session.global_progress.loaded {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_LOAD_STATE",
    ...
    let stat = writable_files.execute(
        ...
        astra_emu_family_api::LegacyWritableFileRequestV1::Stat {
            path: MUSICA_GLOBAL_PROGRESS_PATH.into(),
        },
    )?;
    if !stat.exists {
        if stat.is_file || stat.length != 0 || !stat.entries.is_empty() || !stat.bytes.is_empty() {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_STAT",
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GLOBAL_PROGRESS_READ",
...
fn store_global_progress_if_changed(
    ...
    let create = writable_files.execute(
        ...
        astra_emu_family_api::LegacyWritableFileRequestV1::CreateDir {
            path: MUSICA_GLOBAL_PROGRESS_DIRECTORY.into(),
        },
    )?;
    ...
    let replace = writable_files.execute(
        ...
        astra_emu_family_api::LegacyWritableFileRequestV1::AtomicReplace {
            temporary_path: MUSICA_GLOBAL_PROGRESS_TEMPORARY_PATH.into(),
            destination_path: MUSICA_GLOBAL_PROGRESS_PATH.into(),
        },
    )?;
    validate_writable_mutation_result(
        &replace,
...
fn load_persistent_config(
    ...
    package_hash: Hash256,
    profile_fingerprint: Hash256,
) -> Result<(MusicaConfigState, u32), LegacyProviderError> {
    let stat = writable_files.execute(
        &session_id.0,
        astra_emu_family_api::LegacyWritableFileRequestV1::Stat {
            path: MUSICA_CONFIG_PATH.into(),
        },
    )?;
    if !stat.exists {
        if stat.is_file || stat.length != 0 || !stat.entries.is_empty() || !stat.bytes.is_empty() {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_CONFIG_STAT",
                "missing config returned contradictory metadata",
            ));
        }
        return Ok((MusicaConfigState::default(), 0));
    }
    if !stat.is_file
        || stat.length == 0
        || stat.length > MUSICA_CONFIG_MAX_BYTES as u64
        || !stat.entries.is_empty()
        || !stat.bytes.is_empty()
    {
        return Err(invalid(
    ...
    let envelope = decode_config(read.bytes.as_slice()).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_CONFIG_FORMAT",
            "config envelope is malformed",
        )
    })?;
    if envelope.schema != MUSICA_CONFIG_SCHEMA
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIG_IDENTITY",
            "config identity does not match the active case",
        ));
    }
    envelope.config.validate().map_err(runtime_error)?;
    if envelope.quick_save_cursor >= MUSICA_QUICK_SAVE_SLOT_COUNT {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIG_CURSOR",
...
fn store_persistent_config_if_changed(
    ...
    let envelope = MusicaConfigEnvelope {
        schema: MUSICA_CONFIG_SCHEMA.into(),
    ...
    let payload = encode_config(&envelope).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_CONFIG_ENCODE",
            "config envelope could not be encoded",
        )
    })?;
    if payload.is_empty() || payload.len() > MUSICA_CONFIG_MAX_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIG_BOUNDS",
    ...
    let truncate = writable_files.execute(
        &session_id.0,
        astra_emu_family_api::LegacyWritableFileRequestV1::SetLength {
            path: MUSICA_CONFIG_TEMPORARY_PATH.into(),
            length: 0,
        },
    )?;
    validate_writable_mutation_result(
    ...
    let replace = writable_files.execute(
        &session_id.0,
        astra_emu_family_api::LegacyWritableFileRequestV1::AtomicReplace {
            temporary_path: MUSICA_CONFIG_TEMPORARY_PATH.into(),
            destination_path: MUSICA_CONFIG_PATH.into(),
        },
    )?;
    validate_writable_mutation_result(
        &replace,
...
fn refresh_save_slots(
    ...
    for entry in result.entries {
        ...
        if entry.length == 0 || entry.length > MUSICA_SAVE_MAX_BYTES as u64 {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SAVE_SLOT_BOUNDS",
        ...
        let metadata = if session.save_slot_lengths.get(&slot) == Some(&entry.length) {
            session
                ...
                .ok_or_else(|| {
                    invalid(
                        "ASTRA_EMU_MUSICA_SAVE_LIST_STATE",
...
fn read_save_slot_metadata(
    ...
    slot: u32,
    expected_length: u64,
) -> Result<MusicaSaveSlotMetadata, LegacyProviderError> {
    ...
    if !stat.exists || !stat.is_file || stat.length != expected_length {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_LIST_CHANGED",
    ...
    if read.written != 0 || read.bytes.len() as u64 != expected_length {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_LIST_READ",
...
fn save_slot_metadata_from_envelope(
    envelope: &MusicaSaveEnvelope,
    session: &MusicaSession,
    context: SaveSlotMetadataContext,
) -> Result<MusicaSaveSlotMetadata, LegacyProviderError> {
    if envelope.schema != MUSICA_SAVE_SCHEMA
    ...
    if envelope.comment.len() > MUSICA_SAVE_COMMENT_MAX_BYTES
...
fn validate_save_timestamp(timestamp: &str) -> Result<(), ()> {
    ...
    if bytes.len() != MUSICA_SAVE_TIMESTAMP_MAX_BYTES
        || bytes[4] != b'/'
        || bytes[7] != b'/'
        || bytes[10] != b' '
        || bytes[13] != b':'
...
fn decode_save_thumbnail(bytes: &[u8]) -> Result<Arc<[u8]>, ()> {
    if bytes.is_empty() || bytes.len() > MUSICA_SAVE_THUMBNAIL_MAX_BYTES {
        return Err(());
    }
    let image = image::load_from_memory_with_format(bytes, ImageFormat::Png).map_err(|_| ())?;
    if image.width() != MUSICA_SAVE_THUMBNAIL_WIDTH
        || image.height() != MUSICA_SAVE_THUMBNAIL_HEIGHT
    {
        return Err(());
    }
    let mut rgba = image.into_rgba8().into_raw();
    let expected = usize::try_from(MUSICA_SAVE_THUMBNAIL_WIDTH)
        .ok()
        .and_then(|width| width.checked_mul(usize::try_from(MUSICA_SAVE_THUMBNAIL_HEIGHT).ok()?))
...
fn format_save_timestamp() -> Result<String, LegacyProviderError> {
    ...
    validate_save_timestamp(&timestamp).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_SAVE_TIMESTAMP",
            "current local time cannot be represented in the Musica save format",
        )
    })?;
    Ok(timestamp)
}
...
fn encode_save_thumbnail(frame: &[u8]) -> Result<Vec<u8>, LegacyProviderError> {
    ...
    let thumbnail = image::imageops::resize(
        &image,
        MUSICA_SAVE_THUMBNAIL_WIDTH,
        MUSICA_SAVE_THUMBNAIL_HEIGHT,
    ...
    if encoded.is_empty() || encoded.len() > MUSICA_SAVE_THUMBNAIL_MAX_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL",
...
fn save_slot(
    ...
    validate_save_slot(slot)?;
    if session.vm.state().system_ui.page != MusicaSystemPage::Save {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_PAGE",
            "save slot writes require the save page",
        ));
    }
    if comment.len() > MUSICA_SAVE_COMMENT_MAX_BYTES || comment.chars().any(char::is_control) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_COMMENT",
    ...
    let gameplay_frame = session.last_gameplay_frame.as_deref().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL_MISSING",
    ...
    let mut state = MusicaVm::decode_snapshot(&session.vm.snapshot_bytes().map_err(runtime_error)?)
        .map_err(runtime_error)?;
    state.system_ui.page = MusicaSystemPage::None;
    ...
    let envelope = MusicaSaveEnvelope {
        schema: MUSICA_SAVE_SCHEMA.into(),
        case_fingerprint: session.case_fingerprint,
        package_hash: session.package_hash,
        profile_fingerprint: session.profile_fingerprint,
    ...
    if payload.is_empty() || payload.len() > MUSICA_SAVE_MAX_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_BOUNDS",
...
fn load_slot(
    ...
    if !stat.exists || !stat.is_file {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LOAD_SLOT_EMPTY",
            "selected load slot is empty",
        ));
    }
    if stat.length == 0 || stat.length > MUSICA_SAVE_MAX_BYTES as u64 {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LOAD_SLOT_BOUNDS",
    ...
    let mut state = MusicaVm::decode_snapshot(&envelope.vm_snapshot).map_err(runtime_error)?;
    if state.system_ui.page != MusicaSystemPage::None || state.terminal {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LOAD_SLOT_STATE",
...
fn title_menu_item_count(variant: u8) -> u32 {
    if variant == 2 {
        MUSICA_TITLE_MEMORIES_ITEM_COUNT
    } else {
        MUSICA_TITLE_BASE_ITEM_COUNT
    }
}

fn title_menu_focus_at(variant: u8, x: i32, y: i32) -> Option<u32> {
    if !(MUSICA_TITLE_MENU_LEFT..MUSICA_TITLE_MENU_RIGHT).contains(&x) {
        return None;
    }
    let row_tops = if variant == 2 {
        &MUSICA_TITLE_MENU_ROW_TOPS_MEMORIES[..]
    } else {
        &MUSICA_TITLE_MENU_ROW_TOPS_BASE[..]
    };
    row_tops
        .iter()
        .position(|top| (*top..(*top + MUSICA_TITLE_MENU_ROW_HEIGHT)).contains(&y))
...
fn title_menu_hover_scissor(
    ...
    let row = usize::try_from(focus_index).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_TITLE_POINTER",
    ...
    Ok(LegacyScissorV1 {
        x: MUSICA_TITLE_MENU_HOVER_SCISSOR_X,
        y: top,
        width: MUSICA_TITLE_MENU_RIGHT - MUSICA_TITLE_MENU_HOVER_SCISSOR_X,
        height: MUSICA_TITLE_MENU_ROW_HEIGHT,
    })
}

fn activate_title_focus(vm: &mut MusicaVm) -> Result<MusicaSystemUiAction, LegacyProviderError> {
    match (vm.title_variant(), vm.state().system_ui.focus_index) {
        (_, 0) => {
            vm.set_system_page(MusicaSystemPage::None, 0)
                .map_err(runtime_error)?;
            Ok(MusicaSystemUiAction::StartGame)
        }
        (_, 1) => {
            vm.set_system_page(MusicaSystemPage::Load, 0)
                .map_err(runtime_error)?;
            Ok(MusicaSystemUiAction::Present)
        }
        (_, 2) => {
        ...
        (2, 3) => {
            vm.set_system_page(MusicaSystemPage::Memories, 0)
                .map_err(runtime_error)?;
            Ok(MusicaSystemUiAction::Present)
        }
        (_, 3) | (2, 4) => Ok(MusicaSystemUiAction::Exit),
        _ => Err(invalid(
...
fn apply_system_ui_input(
    vm: &mut MusicaVm,
    input: &LegacyStepInput,
) -> Result<MusicaSystemUiAction, LegacyProviderError> {
    if vm.state().system_ui.page == MusicaSystemPage::Config {
        return apply_config_input(vm, input);
    }
    if vm.state().system_ui.page == MusicaSystemPage::Backlog {
        ...
        if replay && wheel.is_some() {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_BACKLOG_INPUT_AMBIGUOUS",
        ...
        return match (wheel, replay) {
            ...
            (Some(1), false) => Ok(MusicaSystemUiAction::CloseBacklog),
            (None, true) => Ok(MusicaSystemUiAction::ReplayBacklogVoice),
            (None, false) => Ok(MusicaSystemUiAction::Present),
    ...
    if matches!(
        ...
        for edge in input.input_edges.iter().filter(|edge| edge.pressed) {
            match edge.control.as_str() {
                "arrow_up" => vm
                    .move_system_focus(-1, MUSICA_SAVE_MAX_SLOTS)
                    .map_err(runtime_error)?,
                "arrow_down" => vm
                    .move_system_focus(1, MUSICA_SAVE_MAX_SLOTS)
                    .map_err(runtime_error)?,
                ...
                "escape" => {
                    if page == MusicaSystemPage::Load && vm.state().wait.is_none() {
                        vm.set_system_page(MusicaSystemPage::Title, 0)
                            .map_err(runtime_error)?;
                        return Ok(MusicaSystemUiAction::Present);
                    }
                    return Ok(MusicaSystemUiAction::CloseGameplaySystemPage);
                }
                "load" if page == MusicaSystemPage::Save => {
                    vm.open_load_page().map_err(runtime_error)?;
                    return Ok(MusicaSystemUiAction::Present);
                }
                "enter" | "space" => {
                    return Ok(match page {
                        MusicaSystemPage::Save => {
                            MusicaSystemUiAction::SaveSlot(vm.state().system_ui.focus_index)
                        }
                        MusicaSystemPage::Load => {
                            MusicaSystemUiAction::LoadSlot(vm.state().system_ui.focus_index)
                        }
        ...
        if input.input_edges.iter().any(|edge| {
            ...
            if let (Some(column), Some(row)) = (column, row) {
                ...
                return Ok(match page {
                    MusicaSystemPage::Save => MusicaSystemUiAction::SaveSlot(slot),
                    MusicaSystemPage::Load => MusicaSystemUiAction::LoadSlot(slot),
                    _ => unreachable!("save/load branch has a verified page"),
                });
            }
        }
    ...
    let title_pointer_pressed = vm.state().system_ui.page == MusicaSystemPage::Title
        && input
            .input_edges
            .iter()
            .any(|edge| edge.pressed && edge.control == MUSICA_POINTER_PRIMARY);
    let title_pointer_axis = vm.state().system_ui.page == MusicaSystemPage::Title
        && input
            .input_edges
            .iter()
            .any(|edge| matches!(edge.control.as_str(), MUSICA_POINTER_X | MUSICA_POINTER_Y));
    if title_pointer_pressed || title_pointer_axis {
        if input.input_edges.iter().any(|edge| {
            edge.pressed
                && !matches!(
                    edge.control.as_str(),
                    MUSICA_POINTER_X | MUSICA_POINTER_Y | MUSICA_POINTER_PRIMARY
                )
        }) {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_TITLE_POINTER_INPUT_AMBIGUOUS",
        ...
        if title_pointer_pressed {
            return focus
                ...
                .unwrap_or(Ok(MusicaSystemUiAction::Present));
        }
        return Ok(MusicaSystemUiAction::Present);
    }

    let mut action = MusicaSystemUiAction::Present;
    for edge in input.input_edges.iter().filter(|edge| edge.pressed) {
        let page = vm.state().system_ui.page;
        let title_item_count = title_menu_item_count(vm.title_variant());
        match (page, edge.control.as_str()) {
            (MusicaSystemPage::Title, "arrow_up") => vm
                .move_system_focus(-1, title_item_count)
                .map_err(runtime_error)?,
            (MusicaSystemPage::Title, "arrow_down") => vm
                .move_system_focus(1, title_item_count)
                .map_err(runtime_error)?,
            (MusicaSystemPage::Title, "enter" | "space") => {
                action = activate_title_focus(vm)?;
            }
            (MusicaSystemPage::Memories, "arrow_up") => vm
                .move_system_focus(-1, MUSICA_MEMORIES_ITEM_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::Memories, "arrow_down") => vm
                .move_system_focus(1, MUSICA_MEMORIES_ITEM_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::Memories, "enter" | "space") => {
                let target = match vm.state().system_ui.focus_index {
                    ...
                    _ => {
                        return Err(invalid(
                            "ASTRA_EMU_MUSICA_MEMORIES_FOCUS",
            ...
            (MusicaSystemPage::Memories, "escape") => {
                vm.set_system_page(MusicaSystemPage::Title, 0)
                    .map_err(runtime_error)?;
            }
            (MusicaSystemPage::GalleryBgm, "escape") => {
                vm.set_system_page(MusicaSystemPage::Memories, 0)
                    .map_err(runtime_error)?;
                action = MusicaSystemUiAction::GalleryBgmStop;
            }
            (
            ...
            (MusicaSystemPage::GalleryCg, "arrow_up") => vm
                .move_system_focus(-1, MUSICA_GALLERY_CG_PAGE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryCg, "arrow_down") => vm
                .move_system_focus(1, MUSICA_GALLERY_CG_PAGE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryBgm, "arrow_up") => vm
                .move_system_focus(-1, MUSICA_GALLERY_BGM_TRACK_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryBgm, "arrow_down") => vm
                .move_system_focus(1, MUSICA_GALLERY_BGM_TRACK_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryBgm, "arrow_left") => {
                let current = vm.state().system_ui.focus_index;
                let target = current.checked_sub(16).unwrap_or_else(|| {
                    MUSICA_GALLERY_BGM_TRACK_COUNT
                        - ((16 - current) % MUSICA_GALLERY_BGM_TRACK_COUNT)
                });
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
            }
            (MusicaSystemPage::GalleryBgm, "arrow_right") => {
                let current = vm.state().system_ui.focus_index;
                let target = current
                    .checked_add(16)
                    .map(|value| value % MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .unwrap_or(0);
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
            }
            (MusicaSystemPage::GalleryBgm, "enter" | "space") => {
                action = MusicaSystemUiAction::GalleryBgmPlay;
            }
            (MusicaSystemPage::GalleryReplay, "arrow_up") => vm
                .move_system_focus(-1, MUSICA_GALLERY_REPLAY_PAGE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryReplay, "arrow_down") => vm
                .move_system_focus(1, MUSICA_GALLERY_REPLAY_PAGE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryReplay, "enter" | "space") => {
                action = MusicaSystemUiAction::GalleryReplayStart(vm.state().system_ui.focus_index);
            }
            (MusicaSystemPage::GalleryMovie, "arrow_up") => vm
                .move_system_focus(-1, MUSICA_GALLERY_MOVIE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryMovie, "arrow_down") => vm
                .move_system_focus(1, MUSICA_GALLERY_MOVIE_COUNT)
                .map_err(runtime_error)?,
            (MusicaSystemPage::GalleryMovie, "enter" | "space") => {
                action = MusicaSystemUiAction::GalleryMovieStart(vm.state().system_ui.focus_index);
            }
            (MusicaSystemPage::Load, "escape") => {
                vm.set_system_page(MusicaSystemPage::Title, 0)
                    .map_err(runtime_error)?;
            }
            (MusicaSystemPage::Load, "enter" | "space") => {
                return Ok(MusicaSystemUiAction::LoadSlot(
                    vm.state().system_ui.focus_index,
                ));
            }
            _ => {}
        }
        if vm.state().system_ui.page == MusicaSystemPage::GalleryBgm
            && input.input_edges.iter().any(|edge| {
                edge.pressed
                    && edge.control == MUSICA_POINTER_PRIMARY
            ...
            })
        {
            ...
            if track >= MUSICA_GALLERY_BGM_TRACK_COUNT {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_GALLERY_BGM_POINTER",
                    "BGM gallery pointer selected an empty row",
                ));
            }
            vm.set_system_focus(track, MUSICA_GALLERY_BGM_TRACK_COUNT)
                .map_err(runtime_error)?;
            return Ok(MusicaSystemUiAction::GalleryBgmPlay);
        }
        if vm.state().system_ui.page == MusicaSystemPage::GalleryBgm
            && input.input_edges.iter().any(|edge| {
                edge.pressed
            ...
            })
        {
            ...
            return Ok(if (578..644).contains(&x) {
                ...
                let target = current
                    .checked_sub(1)
                    .unwrap_or(MUSICA_GALLERY_BGM_TRACK_COUNT - 1);
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
                MusicaSystemUiAction::Present
                ...
                let target =
                    (vm.state().system_ui.focus_index + 1) % MUSICA_GALLERY_BGM_TRACK_COUNT;
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
                MusicaSystemUiAction::Present
            } else {
            ...
            })
        {
            ...
            if (558..665).contains(&x) {
                let current = vm.state().system_ui.focus_index;
                let target = current.checked_sub(16).unwrap_or_else(|| {
                    let remainder = (16 - current) % MUSICA_GALLERY_BGM_TRACK_COUNT;
                    MUSICA_GALLERY_BGM_TRACK_COUNT - remainder
                });
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
            } else if (700..810).contains(&x) {
                let target =
                    (vm.state().system_ui.focus_index + 16) % MUSICA_GALLERY_BGM_TRACK_COUNT;
                vm.set_system_focus(target, MUSICA_GALLERY_BGM_TRACK_COUNT)
                    .map_err(runtime_error)?;
            } else if (830..906).contains(&x) {
                vm.set_system_page(MusicaSystemPage::Memories, 2)
                    .map_err(runtime_error)?;
            }
            return Ok(MusicaSystemUiAction::Present);
        }
        if action != MusicaSystemUiAction::Present {
            break;
        }
    }
    Ok(action)
...
fn handle_system_menu_request(
    ...
    match request.action {
        LegacySystemMenuActionV1::Open => {
            if session.active_system_menu.is_some() {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_MENU_ALREADY_ACTIVE",
            ...
            let sequence = session
                ...
                .map_err(runtime_error)?;
            let menu =
                musica_system_menu(&session.vm, session.resize_antialias, request, sequence)?;
        ...
        LegacySystemMenuActionV1::Select => {
            ...
            let item_id = request.item_id.as_deref().ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_MENU_ITEM",
            ...
            match item_id {
                ...
                "auto" | "skip" => {
                    ...
                    let wait = session
                        ...
                        .wait
                        .clone()
                        .ok_or_else(|| runtime_error(MusicaRuntimeError::Waiting))?;
                    waiting_output(
                        session,
                        wait,
                        LegacyLiveOutput {
                ...
                "quick_save" => {
                    ...
                    if session.last_quick_save_pc_line != Some(pc_line) {
                        ...
                        session.quick_save_cursor = (cursor + 1) % MUSICA_QUICK_SAVE_SLOT_COUNT;
                        session.save_slots.insert(slot);
                ...
                "game_return_title" | "game_exit" => {
                    let action = if item_id == "game_exit" {
                        MusicaConfirmationAction::Exit
                    } else {
                        MusicaConfirmationAction::ReturnTitle
                    };
                    if action == MusicaConfirmationAction::ReturnTitle
                        && session.vm.state().system_ui.page != MusicaSystemPage::None
                    {
                        return Err(invalid(
                            "ASTRA_EMU_MUSICA_CONFIRMATION_CONTEXT",
                    ...
                    let sequence = session
                        ...
                        .allocate_effect_sequence()
                        .map_err(runtime_error)?;
                    let confirmation_id = format!("musica.confirmation.{item_id}.{sequence}");
                    let confirmation = LegacyConfirmationTransactionV1 {
                        sequence,
                        confirmation_id: confirmation_id.clone(),
                        title: MUSICA_CONFIRMATION_TITLE.into(),
                        message: musica_confirmation_message(action).into(),
                        accept_label: MUSICA_CONFIRMATION_ACCEPT_LABEL.into(),
                        cancel_label: MUSICA_CONFIRMATION_CANCEL_LABEL.into(),
                    };
                    services
                ...
                "window_precision" => Err(invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_MENU_ITEM_DISABLED",
                    "the observed Musica precision resize item is disabled",
                )),
                "window_fullscreen"
                ...
                | "help_homepage" => {
                    ...
                    let sequence = session
                        ...
                        .allocate_effect_sequence()
                        .map_err(runtime_error)?;
                    let command_id = format!("musica.system_command.{item_id}.{sequence}");
                    services.system_commands.publish(
                        &session_id.0,
                        LegacySystemCommandTransactionV1 {
                            sequence,
                ...
                _ => Err(invalid(
                    "ASTRA_EMU_MUSICA_SYSTEM_MENU_ITEM_UNKNOWN",
                    "system-menu selection references an unknown Musica command",
                )),
            }
        }
    }
...
fn handle_confirmation_step(
        ...
        || !input.provider_results.is_empty()
    {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIRMATION_INPUT_WHILE_ACTIVE",
    ...
    let active = session.active_confirmation.clone().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_CONFIRMATION_NOT_ACTIVE",
            "confirmation result has no active Musica transaction",
        )
    })?;
...
fn handle_text_input_step(
        ...
        || !input.provider_results.is_empty()
    {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_INPUT_INPUT_WHILE_ACTIVE",
    ...
    let active = session.active_text_input.clone().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_TEXT_INPUT_NOT_ACTIVE",
            "text-input result has no active Musica transaction",
        )
    })?;
    ...
    if result.prompt_id != active.prompt_id {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_INPUT_ID_MISMATCH",
            "text-input result does not match the active Musica transaction",
        ));
    }
    if result.value.len() > active.max_bytes as usize {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_INPUT_VALUE",
            "text-input result exceeds the active Musica transaction bound",
        ));
    }
...
fn handle_system_command_step(
        ...
        || !input.provider_results.is_empty()
    {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_COMMAND_INPUT_WHILE_ACTIVE",
    ...
    let active = session.active_system_command.clone().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_COMMAND_NOT_ACTIVE",
            "system command result has no active Musica transaction",
        )
    })?;
    ...
    if result.command_id != active.command_id {
        session.poisoned = true;
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_COMMAND_ID_MISMATCH",
            "system command result does not match the active Musica transaction",
        ));
    }
    ...
    match result.status {
        LegacySystemCommandStatusV1::Applied => {
            match active.command {
                ...
                | LegacySystemCommandKindV1::OpenHomepage => {
                    ...
                    // the deterministic Musica VM state.  An Applied result
        ...
        LegacySystemCommandStatusV1::Rejected => {
            session.poisoned = true;
            Err(invalid(
                "ASTRA_EMU_MUSICA_SYSTEM_COMMAND_REJECTED",
                "native host rejected the Musica system command",
            ))
        }
        LegacySystemCommandStatusV1::Unsupported => {
            session.poisoned = true;
            Err(invalid(
                "ASTRA_EMU_MUSICA_SYSTEM_COMMAND_UNSUPPORTED",
                "native host does not support the Musica system command",
            ))
        }
    }
}
...
fn validate_confirmation_result(
    active: &ActiveMusicaConfirmation,
    result: &LegacyConfirmationResultV1,
) -> Result<(), LegacyProviderError> {
    result.validate()?;
    if result.confirmation_id != active.confirmation_id {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIRMATION_ID_MISMATCH",
            "confirmation result does not match the active Musica transaction",
        ));
    }
    Ok(())
}
...
fn validate_active_system_menu(
    ...
    let menu = session.active_system_menu.as_ref().ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_ID_MISMATCH",
            "system-menu result has no active Musica menu",
        )
    })?;
    if Some(menu.menu_id.as_str()) != request.menu_id.as_deref() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_ID_MISMATCH",
            "system-menu result does not match the active Musica menu",
        ));
    }
...
fn musica_system_menu(
    vm: &MusicaVm,
    resize_antialias: bool,
    request: &astra_emu_family_api::LegacySystemMenuRequestV1,
    sequence: u64,
) -> Result<LegacySystemMenuTransactionV1, LegacyProviderError> {
    let title = vm.state().system_ui.page == MusicaSystemPage::Title;
    ...
    let menu = LegacySystemMenuTransactionV1 {
        sequence,
        menu_id: format!("musica.system_menu.{sequence}"),
...
fn validate_system_menu_open(
    ...
    if !input.await_results.is_empty() || !input.provider_results.is_empty() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_RESULT_UNEXPECTED",
    ...
    if input.input_edges.iter().any(|edge| {
        edge.pressed
            && !matches!(
                edge.control.as_str(),
                MUSICA_POINTER_X | MUSICA_POINTER_Y | "pointer.secondary"
            )
    }) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_INPUT_AMBIGUOUS",
    ...
    if vm.state().system_ui.page != MusicaSystemPage::None {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_PAGE_ACTIVE",
    ...
    match vm.state().wait.as_ref() {
        ...
        Some(MusicaWaitState::Choice { .. }) => Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_CHOICE_ACTIVE",
            "right-click system-menu open is not valid while a choice is active",
        )),
        Some(MusicaWaitState::Media { .. }) => Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_MEDIA_ACTIVE",
        ...
        Some(
            ...
            | MusicaWaitState::Presentation { .. }
            | MusicaWaitState::Provider { .. },
        )
        | None => Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_MENU_WAIT_STATE",
...
fn apply_config_input(
    ...
    if action_count > 1 {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CONFIG_INPUT_AMBIGUOUS",
    ...
    match vm.apply_config_control(control).map_err(runtime_error)? {
        MusicaConfigChange::Present => Ok(MusicaSystemUiAction::Present),
        MusicaConfigChange::AudioParamsChanged => Ok(MusicaSystemUiAction::PresentWithAudioRefresh),
        MusicaConfigChange::Applied => Ok(MusicaSystemUiAction::PresentAfterConfigClose {
            fullscreen: (vm.state().system_ui.config.fullscreen != fullscreen_before)
                .then_some(vm.state().system_ui.config.fullscreen),
        }),
        MusicaConfigChange::Cancelled => {
            Ok(MusicaSystemUiAction::PresentAfterConfigClose { fullscreen: None })
        }
        MusicaConfigChange::TestAudio(bus) => Ok(MusicaSystemUiAction::PresentWithAudioTest(bus)),
    }
}

fn config_control_at(x: i32, y: i32) -> Option<MusicaConfigControl> {
        ...
        .filter(|edge| edge.control == "wheel")
    {
        ...
        if let Some(current) = current {
            if direction.is_some_and(|existing| existing != current) {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_BACKLOG_WHEEL_AMBIGUOUS",
...
fn system_ui_output(
    ...
    tracing::info!(
        target: "astra_emu_musica::system_ui",
        event = "astra_emu_musica_system_ui_output",
        page = system_page_name(session.vm.state().system_ui.page),
        terminal = session.vm.state().terminal,
        fixed_tick = input.tick_index,
    ...
    if status != LegacyRuntimeStatus::Terminal && system_page_changed {
        live.clear_text = true;
        let is_backlog = session.vm.state().system_ui.page == MusicaSystemPage::Backlog;
        let sequence = session
            .vm
            .allocate_effect_sequence()
            .map_err(runtime_error)?;
        live.resource_scenes.push(LegacySequenced {
            ...
            value: if is_backlog {
                ...
                describe_system_page_with_slots_and_hover(
                    ...
                    &session.vm,
                    &session.save_slots,
                    (session.vm.state().system_ui.page == MusicaSystemPage::Title)
        ...
        } else if session.vm.state().system_ui.page == MusicaSystemPage::GalleryMovie {
    ...
    if session.vm.state().system_ui.page == MusicaSystemPage::Backlog
        && input.await_results.is_empty()
        && input.input_edges.is_empty()
...
fn append_validated_audio_commands<'a>(
    vfs: &Arc<dyn LegacyVfsReader>,
    mount_set_id: &str,
    commands: impl IntoIterator<Item = &'a MusicaAudioCommand>,
    state: &MusicaRuntimeState,
...
fn gameplay_resume_output(
    ...
    let stage_size = session.stage_size.ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_BACKLOG_STAGE_SIZE",
    ...
    let current_message = match current_message {
        ...
        Some(None) => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_BACKLOG_MESSAGE_IDENTITY",
...
fn append_resumed_message_text(
    ...
    let capture_sequence = session
        ...
        .allocate_effect_sequence()
        .map_err(runtime_error)?;
    let lease_id = format!("musica.text.resume.{tick_index}.{capture_sequence}");
    let presentation = LegacyTextPresentationLeaseV1 {
        lease_id: lease_id.clone(),
        presentation: musica_message_presentation(
            session.stage_size,
            session.vm.state().system_ui.config.text_shadow,
        )?,
    };
    ...
    live.text.push(StagedTextLease {
        ...
        source_ref: "musica.sc.message.resume".into(),
    });
    Ok(())
}
...
fn append_save_load_text(
    ...
    for visible_index in 0..10_u32 {
        let slot = page_base.checked_add(visible_index).ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_SAVE_LOAD_TEXT",
        ...
        let capture_sequence = session
            ...
            .allocate_effect_sequence()
            .map_err(runtime_error)?;
        let lease_id = format!("musica.save-slot.{tick_index}.{slot}.{capture_sequence}");
        let presentation = LegacyTextPresentationLeaseV1 {
            lease_id: lease_id.clone(),
            presentation: musica_save_slot_text_presentation(
                session.stage_size,
        ...
        live.text.push(StagedTextLease {
            ...
            source_ref: "musica.save_slot.metadata".into(),
        });
    }
    Ok(())
}

fn musica_save_slot_text_presentation(
    stage_size: Option<(u32, u32)>,
    x: i32,
    y: i32,
) -> Result<LegacyTextPresentationV1, LegacyProviderError> {
    if stage_size != Some((1280, 720)) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_LOAD_TEXT_STAGE",
            "save slot metadata requires the verified 1280x720 stage",
        ));
    }
    let presentation = LegacyTextPresentationV1 {
        layout_id: format!("musica.save-slot.{x}.{y}"),
        language: "ja-JP".into(),
        font_families: vec!["Noto Sans JP".into()],
        body: LegacyTextRegionV1 {
            x,
...
fn append_gallery_movie_text(
    ...
    if selected >= MUSICA_GALLERY_MOVIE_LABELS.len() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_MOVIE_FOCUS",
            "movie gallery focus is outside the verified range",
        ));
    }
    let text = MUSICA_GALLERY_MOVIE_LABELS
        .iter()
        .enumerate()
        .map(|(index, label)| {
            if index == selected {
    ...
    if text.len() > MAX_EPHEMERAL_TEXT_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_MOVIE_TEXT_BOUNDS",
    ...
    let capture_sequence = session
        ...
        .allocate_effect_sequence()
        .map_err(runtime_error)?;
    let lease_id = format!("musica.gallery.movie.{tick_index}.{capture_sequence}");
    let presentation = LegacyTextPresentationLeaseV1 {
        lease_id: lease_id.clone(),
        presentation: musica_gallery_movie_presentation(session.stage_size)?,
    };
    presentation.validate()?;
    if session
        .ephemeral_text
    ...
    live.text.push(StagedTextLease {
        ...
        source_ref: "musica.gallery.movie".into(),
    });
    Ok(())
}
...
fn append_backlog_text(
    ...
    let cursor = usize::try_from(session.vm.state().system_ui.backlog_cursor.ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_BACKLOG_CURSOR",
    ...
    let capture_sequence = session
        ...
        .allocate_effect_sequence()
        .map_err(runtime_error)?;
    let lease_id = format!("musica.text.backlog.{tick_index}.{capture_sequence}");
    let presentation = LegacyTextPresentationLeaseV1 {
        lease_id: lease_id.clone(),
    ...
    live.text.push(StagedTextLease {
        ...
        source_ref: "musica.sc.backlog".into(),
    });
    Ok(())
}
...
fn describe_backlog_frame(
    ...
    if stage_size != (1280, 720) || state.system_ui.page != MusicaSystemPage::Backlog {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_BACKLOG_STAGE_IDENTITY",
    ...
    append_resource_layer(
        ...
        1.0,
        MUSICA_BACKLOG_BALL_TEXTURE_ID,
        &mut frame.texture_resources,
        &mut frame.draws,
    )?;
...
fn describe_system_page_with_slots_and_hover(
    ...
    if (width, height) != (1280, 720) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SYSTEM_STAGE_IDENTITY",
            "verified Musica system pages require the 1280x720 reference stage",
        ));
    }
    if vm.state().system_ui.page == MusicaSystemPage::Config {
    ...
    if vm.state().system_ui.page == MusicaSystemPage::GalleryReplay {
        return describe_gallery_replay_page(vfs, mount_set_id, width, height, vm);
    }
    if vm.state().system_ui.page == MusicaSystemPage::GalleryMovie {
        return describe_gallery_movie_page(vfs, mount_set_id, width, height);
    }
    if vm.state().system_ui.page == MusicaSystemPage::GalleryCg {
    ...
    let resource_uri = match vm.state().system_ui.page {
        ...
        MusicaSystemPage::Load => unreachable!("save/load uses the stateful presentation path"),
        MusicaSystemPage::Config => unreachable!("config uses its stateful presentation path"),
        MusicaSystemPage::Memories => "musica:/sys/memories.png",
        MusicaSystemPage::GalleryCg
        ...
        MusicaSystemPage::GalleryMovie => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_GALLERY_MOVIE_SCRIPT_REQUIRED",
                "the original movie gallery is script-driven and is not a static system page",
            ));
        }
        MusicaSystemPage::None => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SYSTEM_PAGE",
                "gameplay does not have a system-page presentation",
            ));
        }
        MusicaSystemPage::Save | MusicaSystemPage::Backlog => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SYSTEM_PAGE_PRESENTATION_ROUTE",
    ...
    let resource = texture_resources
        .first()
        .ok_or_else(|| invalid("ASTRA_EMU_MUSICA_SYSTEM_RESOURCE", "title resource missing"))?;
...
fn describe_gallery_bgm_page(
    ...
    let page = read_texture_resource(vfs, mount_set_id, page_uri, MUSICA_SYSTEM_TEXTURE_ID)?;
    if (page.decoded_width, page.decoded_height) != (width, height) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_BGM_RESOURCE_DIMENSIONS",
    ...
    let note = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/musicNote.png",
        MUSICA_SYSTEM_TEXTURE_ID + 1,
    )?;
    ...
    let note_y = 96i32
        .checked_add(
            i32::try_from(row).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_GALLERY_BGM_FOCUS",
...
fn describe_gallery_replay_page(
    ...
    let page_uri = MUSICA_GALLERY_REPLAY_PAGE_URIS.get(index).ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_GALLERY_REPLAY_FOCUS",
            "flashback gallery focus is outside the verified range",
        )
    })?;
    let menu_uri = format!("musica:/sys/flash{index}menu.png");
    let page = read_texture_resource(vfs, mount_set_id, page_uri, MUSICA_SYSTEM_TEXTURE_ID)?;
    let menu = read_texture_resource(vfs, mount_set_id, &menu_uri, MUSICA_SYSTEM_TEXTURE_ID + 1)?;
    if (page.decoded_width, page.decoded_height) != (width, height)
        || (menu.decoded_width, menu.decoded_height) != (384, 64)
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_REPLAY_RESOURCE_DIMENSIONS",
...
fn describe_gallery_movie_page(
    ...
    let background = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/memories.png",
        MUSICA_SYSTEM_TEXTURE_ID,
    )?;
    if (background.decoded_width, background.decoded_height) != (width, height) {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_GALLERY_MOVIE_RESOURCE_DIMENSIONS",
...
fn describe_gallery_cg_page(
    ...
    let page_index = usize::try_from(vm.state().system_ui.focus_index).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_GALLERY_CG_RESOURCE",
            "CG gallery page index cannot be represented",
        )
    })?;
    let page_label_uri = MUSICA_GALLERY_CG_PAGE_URIS.get(page_index).ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_GALLERY_CG_RESOURCE",
    ...
    let page_label = read_texture_resource(
        ...
        mount_set_id,
        page_label_uri,
        MUSICA_SYSTEM_TEXTURE_ID + 3,
    )?;
    let mut thumbnails =
        vfs.enumerate_by_extension(mount_set_id, "musica:/sys/cgthumb", "png", 256)?;
    ...
    for (visible_index, thumbnail) in thumbnails.iter().skip(page_start).take(16).enumerate() {
        let thumbnail = read_texture_resource(
            ...
            mount_set_id,
            &thumbnail.uri,
            MUSICA_GALLERY_CG_THUMB_TEXTURE_BASE
...
fn describe_save_load_page(
    ...
    let base = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/saveloadBase.png",
        MUSICA_SYSTEM_TEXTURE_ID,
    )?;
    let title_uri = match vm.state().system_ui.page {
        MusicaSystemPage::Save => "musica:/sys/saveloadSave.png",
        MusicaSystemPage::Load => "musica:/sys/saveloadLoad.png",
        _ => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SAVE_LOAD_PAGE",
                "save/load renderer received an unrelated system page",
            ));
        }
    };
    let title = read_texture_resource(vfs, mount_set_id, title_uri, MUSICA_SYSTEM_TEXTURE_ID + 1)?;
    let select = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/saveloadSelect.png",
        MUSICA_SYSTEM_TEXTURE_ID + 2,
    )?;
    ...
    let page_uri = format!("musica:/sys/saveload_Page{page_index}.png");
    let page = read_texture_resource(vfs, mount_set_id, &page_uri, MUSICA_SYSTEM_TEXTURE_ID + 3)?;
    let buttons = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/saveloadButtons.png",
        MUSICA_SYSTEM_TEXTURE_ID + 4,
    )?;
    let not_saved = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/notsaved.png",
        MUSICA_SYSTEM_TEXTURE_ID + 5,
    )?;
    if (base.decoded_width, base.decoded_height) != (width, height)
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_LOAD_RESOURCE_DIMENSIONS",
    ...
    append_texture_draw(
        &title,
        MUSICA_SAVE_LOAD_TITLE_X,
        MUSICA_SAVE_LOAD_HEADER_Y,
        1.0,
        &mut draws,
    )?;
    append_texture_draw_with_scissor(
        ...
        656,
        1.0,
        (vm.state().system_ui.page == MusicaSystemPage::Save).then_some(LegacyScissorV1 {
            x: 578,
            y: 656,
            width: 240,
            height: 48,
...
fn gallery_resource_uri(
    ...
    let resource = match page {
        MusicaSystemPage::GalleryCg => MUSICA_GALLERY_CG_PAGE_URIS
        ...
        MusicaSystemPage::GalleryBgm => {
            if focus_index >= MUSICA_GALLERY_BGM_TRACK_COUNT {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_GALLERY_FOCUS",
                    "BGM gallery focus is outside the verified track range",
                ));
            }
            MUSICA_GALLERY_BGM_PAGE_URIS
        ...
        MusicaSystemPage::GalleryReplay => MUSICA_GALLERY_REPLAY_PAGE_URIS
            .get(usize::try_from(focus_index).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_GALLERY_FOCUS",
...
fn describe_config_page(
    ...
    let knob = read_texture_resource(
        ...
        mount_set_id,
        "musica:/sys/knob.png",
        MUSICA_CONFIG_KNOB_TEXTURE_ID,
    )?;
    let checkmark = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/checkmark.png",
        MUSICA_CONFIG_CHECKMARK_TEXTURE_ID,
    )?;
    let circle = read_texture_resource(
        vfs,
        mount_set_id,
        "musica:/sys/circle.png",
        MUSICA_CONFIG_CIRCLE_TEXTURE_ID,
    )?;
    if (base.decoded_width, base.decoded_height) != (width, height)
    ...
    checks.push(match config.preferred_play_mode {
        MusicaPlayMode::Auto => (40, 588),
        MusicaPlayMode::Skip => (153, 588),
        MusicaPlayMode::Normal => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_CONFIG_PLAY_MODE",
...
fn append_choice_live_output(
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CHOICE_TEXT_BOUNDS",
    ...
    for (index, option) in options.into_iter().enumerate() {
        ...
        let capture_sequence = session
            ...
            .allocate_effect_sequence()
            .map_err(runtime_error)?;
        let lease_id = format!("musica.choice.{tick_index}.{capture_sequence}.{index}");
        let presentation = LegacyTextPresentationLeaseV1 {
            lease_id: lease_id.clone(),
            presentation: LegacyTextPresentationV1 {
                layout_id: format!("musica.choice.option.{index}"),
                language: "ja-JP".into(),
                font_families: vec!["Noto Sans JP".into()],
                body: LegacyTextRegionV1 {
                    x: layout.left,
        ...
        live.text.push(StagedTextLease {
            ...
            source_ref: "musica.sc.select".into(),
        });
    }
...
> {
    let (stage_width, stage_height) = stage_size.ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_CHOICE_STAGE_IDENTITY",
    ...
    let mut choice_resources = Vec::with_capacity(MUSICA_CHOICE_RESOURCE_URIS.len());
    for (index, uri) in MUSICA_CHOICE_RESOURCE_URIS.iter().enumerate() {
        let texture_id = MUSICA_CHOICE_TEXTURE_BASE
            .checked_add(u32::try_from(index).map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_CHOICE_RESOURCE",
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_CHOICE_RESOURCE_IDENTITY",
...
fn choice_direction(control: &str) -> Option<i32> {
    if control == MUSICA_CHOICE_NAVIGATION_CONTROLS[0] {
        Some(-1)
    } else if control == MUSICA_CHOICE_NAVIGATION_CONTROLS[1] {
        Some(1)
    } else {
        None
    }
...
fn choice_presentation_from_parts(
    ...
    let payload = postcard::to_allocvec(&MusicaChoicePresentation {
        schema: MUSICA_CHOICE_PRESENTATION_SCHEMA.into(),
        option_hashes: option_hashes.to_vec(),
        selected_index,
    })
    .map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_CHOICE_ENCODE",
            "choice presentation could not be encoded",
        )
    })?;
    Ok(LegacyEvent {
        sequence,
        event: MUSICA_CHOICE_PRESENTATION_SCHEMA.into(),
...
fn legacy_wait(wait: &MusicaWaitState, state: &MusicaRuntimeState) -> LegacyWaitRequest {
    match wait {
        MusicaWaitState::Time {
            token_id,
            timer_ticks: _,
        ...
        MusicaWaitState::Input { token_id } => LegacyWaitRequest::Input {
            token_id: token_id.clone(),
            keys: message_input_keys(
                state.system_ui.skip_enabled && state.system_ui.control_enabled,
            ),
        },
        MusicaWaitState::Choice { token_id } => LegacyWaitRequest::Input {
            token_id: token_id.clone(),
            keys: choice_input_keys(),
        },
        MusicaWaitState::Media { token_id, media_id } => LegacyWaitRequest::MediaFence {
            token_id: token_id.clone(),
            media_id: media_id.clone(),
        },
        MusicaWaitState::Presentation { token_id, fence_id } => {
...
fn wait_token(wait: &MusicaWaitState) -> &str {
    match wait {
        ...
        | MusicaWaitState::Choice { token_id }
...
impl MusicaLayerRole {
    ...
    fn classify(texture_id: u32) -> Result<Self, LegacyProviderError> {
        match texture_id {
            ...
            16..=99 | MUSICA_CHARACTER_TEXTURE_BASE..=19_999 => Ok(Self::Foreground),
            100 | 101 | 300..=302 | 600..=602 => Ok(Self::Effect),
            200 | MUSICA_CHOICE_TEXTURE_BASE..=502 | MUSICA_SYSTEM_TEXTURE_ID.. => Ok(Self::Panel),
            _ => Err(invalid(
                "ASTRA_EMU_MUSICA_LAYER_CLASSIFICATION",
                "render texture id has no verified Musica layer role",
            )),
        }
    }
}

struct PreparedMusicaLayer {
    role: MusicaLayerRole,
    rgba8_premultiplied: Arc<[u8]>,
}

#[derive(Debug, Clone, PartialEq)]
struct CachedMusicaLayer {
    width: u32,
    height: u32,
...
fn publish_v9_output(
    ...
    // Resource-backed scenes are retained by the current Family ABI host. Musica emits a
    ...
    let text_operation = match prepared_text {
        ...
        None if staged.live.clear_text && session.published_layers.remove(MUSICA_TEXT_LAYER_ID) => {
            Some(LegacyLayerOperationV9::Destroy {
                layer_id: MUSICA_TEXT_LAYER_ID.into(),
            })
        }
        None => None,
    };
    if let Some(operation) = text_operation {
        if let Some(transaction) = layers.first_mut() {
            ...
            let (viewport_width, viewport_height) = session.stage_size.ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_TEXT_STAGE_IDENTITY",
                    "text layer output requires the verified Musica stage",
                )
            })?;
    ...
    if session.vm.state().system_ui.page == MusicaSystemPage::None {
        if let Some(frame) = compose_musica_frame(
            session.stage_size,
...
fn prepare_text_surface(
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_BATCH_IDENTITY",
    ...
    if presentations.len() != staged.live.text_presentations.len() {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_TEXT_PRESENTATION_DUPLICATE",
    ...
    for lease in &staged.live.text {
        let captured = session.ephemeral_text.get(&lease.lease_id).ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_TEXT_LEASE_MISSING",
    ...
    let (width, height) = session.stage_size.ok_or_else(|| {
        invalid(
            "ASTRA_EMU_MUSICA_TEXT_STAGE_IDENTITY",
            "text output requires the verified Musica stage",
        )
    })?;
    let rgba8_premultiplied = session
        ...
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_TEXT_RENDERER_MISSING",
                "text output has no family-owned CosmicText renderer",
            )
        })?
        .render(&requests)
        .map_err(|code| invalid(code, "Musica text rasterization failed"))?;
    for lease_id in consumed {
        session.ephemeral_text.remove(&lease_id).ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_TEXT_LEASE_STATE",
...
fn publish_text_surface(
    ...
    Ok(
        if session.published_layers.insert(MUSICA_TEXT_LAYER_ID.into()) {
...
fn compose_musica_frame(
    stage_size: Option<(u32, u32)>,
    layers: &BTreeMap<MusicaLayerRole, CachedMusicaLayer>,
    ...
    let byte_count = pixel_count
        ...
        .ok_or_else(|| invalid("ASTRA_EMU_MUSICA_SAVE_THUMBNAIL", "frame size overflowed"))?;
    let mut frame = vec![0_u8; byte_count];
    let mut has_surface = false;
    for role in MusicaLayerRole::ALL {
        if let Some(layer) = layers.get(&role) {
                ...
                || layer.rgba8_premultiplied.len() != byte_count
            {
                return Err(invalid(
                    "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL",
                    "cached Musica layer does not match the verified stage",
                ));
            }
    ...
    if let Some(text) = text_surface {
        if text.len() != byte_count {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL",
                "cached Musica text surface does not match the verified stage",
            ));
        }
...
fn next_layer_sequence(
    ...
    current_step_sequence
        ...
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_SEQUENCE",
...
fn publish_resource_scene(
    ...
    presentation_layers: &mut BTreeMap<MusicaLayerRole, CachedMusicaLayer>,
    frame: &LegacyRenderResourceFrameV1,
    save_overlay: Option<(&BTreeMap<u32, MusicaSaveSlotMetadata>, u32)>,
    ...
    let prepared = prepared
        .into_iter()
        .map(|layer| {
            if layer.role == MusicaLayerRole::Panel {
    ...
    for layer in prepared {
        let surface_id = format!("musica.surface.{}", layer.role.symbol());
        let mut lease = services.surfaces.acquire(
            &session_id.0,
            fixed_step,
            &surface_id,
    ...
    for (role, lease) in leases {
        let layer_id = format!("musica.layer.{}", role.symbol());
        let state = LegacyLayerStateV9 {
...
fn overlay_save_thumbnails(
    layer: PreparedMusicaLayer,
    metadata: &BTreeMap<u32, MusicaSaveSlotMetadata>,
    page_base: u32,
    width: u32,
    height: u32,
) -> Result<PreparedMusicaLayer, LegacyProviderError> {
    if width != 1280 || height != 720 {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL_STAGE",
    ...
    let expected = usize::try_from(width)
        ...
        .ok_or_else(|| invalid("ASTRA_EMU_MUSICA_SAVE_THUMBNAIL", "panel size overflowed"))?;
    ...
    for visible_index in 0..10_u32 {
        ...
        let thumbnail_expected = usize::try_from(MUSICA_SAVE_THUMBNAIL_WIDTH)
            .ok()
            .and_then(|value| {
                value.checked_mul(usize::try_from(MUSICA_SAVE_THUMBNAIL_HEIGHT).ok()?)
            })
            .and_then(|value| value.checked_mul(4))
            .ok_or_else(|| {
                invalid(
...
fn blit_save_thumbnail(
    ...
    let source_width = usize::try_from(MUSICA_SAVE_THUMBNAIL_WIDTH).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL",
            "thumbnail width cannot be represented",
        )
    })?;
    let source_height = usize::try_from(MUSICA_SAVE_THUMBNAIL_HEIGHT).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_SAVE_THUMBNAIL",
...
fn prepare_resource_layers(
    ...
    frame: &LegacyRenderResourceFrameV1,
    presentation_layers: &mut BTreeMap<MusicaLayerRole, CachedMusicaLayer>,
) -> Result<Vec<PreparedMusicaLayer>, LegacyProviderError> {
    let layer_bytes = u64::from(frame.width)
        .checked_mul(u64::from(frame.height))
        .and_then(|pixels| pixels.checked_mul(4))
        .and_then(|bytes| bytes.checked_mul(MusicaLayerRole::ALL.len() as u64))
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_BOUNDS",
                "Musica layer surface size overflowed",
            )
        })?;
    if layer_bytes > MAX_LAYER_SURFACE_BYTES {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LAYER_BOUNDS",
            "Musica layer surfaces exceed the decoded byte budget",
        ));
    }
    let resources = frame
        .texture_resources
        ...
        .collect::<BTreeMap<_, _>>();
    let mut draws = BTreeMap::<MusicaLayerRole, Vec<&LegacyDrawV1>>::new();
    for draw in &frame.draws {
        draws
            .entry(MusicaLayerRole::classify(draw.texture_id)?)
            .or_default()
            .push(draw);
    }
    MusicaLayerRole::ALL
        ...
        .map(|role| {
            ...
            for draw in &role_draws {
                let resource = resources.get(&draw.texture_id).ok_or_else(|| {
                    invalid(
                        "ASTRA_EMU_MUSICA_LAYER_RESOURCE",
...
fn validate_cached_layer_sources(
    ...
    for resource in resources {
        ...
        {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_REVISION",
                "cached Musica layer source changed after the resource scene was staged",
            ));
        }
    }
    Ok(())
...
fn render_resource_layer(
    ...
    let mut renderer = CpuRendererProvider
        .create(RendererCreateRequest {
            ...
            profile: "astra.emu.musica.layer.v1".into(),
        })
        .map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_RENDERER",
                "Astra Renderer2D rejected the Musica layer target",
            )
        })?;
    ...
    for (draw_index, draw) in draws.into_iter().enumerate() {
        ...
        let texture_symbol = format!("musica.texture.{}", draw.texture_id);
        ...
        commands.push(SceneCommand::Mesh2D {
            id: format!("musica.draw.{draw_index}"),
    ...
    let mut rgba8 = renderer
        ...
        .map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_RENDER",
                "Astra Renderer2D failed the bounded Musica layer render",
            )
        })?
        .bytes;
...
fn decode_texture(
    ...
    if resource.decoded_format != LegacyTextureFormat::Rgba8 {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LAYER_TEXTURE_FORMAT",
            "Musica layer texture is not RGBA8",
        ));
    }
    let decoded_bytes = u64::from(resource.decoded_width)
        ...
        .ok_or_else(|| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_BOUNDS",
    ...
    let provider_id = match resource.codec.as_str() {
        "ani" | "sqz" => MUSICA_IMAGE_DECODE_PROVIDER_ID,
        "png" | "bmp" | "jpg" | "jpeg" | "webp" => "astra.decode.image",
        _ => {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_CODEC",
    ...
    if provider_id == "astra.decode.image" {
        let reader = image::ImageReader::new(Cursor::new(encoded.as_slice()))
            ...
            .map_err(|_| {
                invalid(
                    "ASTRA_EMU_MUSICA_LAYER_TEXTURE_CODEC",
                    "image provider could not identify the Musica layer texture",
                )
            })?;
    ...
    let result = decoders
        .decode(
            ...
            &DecodeBindingContext::shipping(
                provider_id,
                "astra-emu-musica",
                "astra.emu.musica.layer.v1",
            ),
        )
        .map_err(musica_media_decode_error)?;
    let DecodeOutput::CpuBuffer { bytes, format } = result.output else {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LAYER_TEXTURE_DECODE",
            "bound Musica image provider did not return a CPU texture buffer",
        ));
    };
    if provider_id == MUSICA_IMAGE_DECODE_PROVIDER_ID {
        let dimensions = format
            ...
            .ok_or_else(|| {
                invalid(
                    "ASTRA_EMU_MUSICA_LAYER_TEXTURE_CODEC",
                    "Musica image provider returned an invalid first-frame format",
                )
            })?;
        let width = dimensions.0.parse::<u32>().map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_CODEC",
                "Musica image provider returned an invalid first-frame width",
            )
        })?;
        let height = dimensions.1.parse::<u32>().map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_CODEC",
                "Musica image provider returned an invalid first-frame height",
            )
        })?;
        if (width, height) != (resource.decoded_width, resource.decoded_height) {
            return Err(invalid(
                "ASTRA_EMU_MUSICA_LAYER_TEXTURE_IDENTITY",
...
fn musica_media_decode_error(error: astra_media::MediaError) -> LegacyProviderError {
    LegacyProviderError::invalid("ASTRA_EMU_MUSICA_LAYER_TEXTURE_DECODE", error.to_string())
}
...
fn convert_vertex(vertex: &LegacyVertexV1) -> Result<MeshVertex2D, LegacyProviderError> {
    ...
    {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LAYER_VERTEX",
            "Musica layer vertex is outside the Renderer2D contract",
        ));
    }
...
fn convert_scissor(scissor: LegacyScissorV1) -> Result<RectI, LegacyProviderError> {
    let width = u32::try_from(scissor.width).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_LAYER_SCISSOR",
            "Musica layer scissor width is invalid",
        )
    })?;
    let height = u32::try_from(scissor.height).map_err(|_| {
        invalid(
            "ASTRA_EMU_MUSICA_LAYER_SCISSOR",
            "Musica layer scissor height is invalid",
        )
    })?;
    if width == 0 || height == 0 {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_LAYER_SCISSOR",
            "Musica layer scissor is empty",
        ));
    }
...
fn write_surface_rows(
    ...
    let row_bytes = usize::try_from(lease.width)
        ...
        .ok_or_else(|| invalid("ASTRA_EMU_MUSICA_SURFACE_BOUNDS", "surface row overflowed"))?;
    let expected = row_bytes
        .checked_mul(usize::try_from(lease.height).map_err(|_| {
            invalid(
                "ASTRA_EMU_MUSICA_SURFACE_BOUNDS",
                "surface height cannot be represented",
            )
        })?)
        .ok_or_else(|| invalid("ASTRA_EMU_MUSICA_SURFACE_BOUNDS", "surface size overflowed"))?;
...
fn validate_session_binding(
    ...
    if ctx.mount_set_id != session.mount_set_id {
        return Err(invalid(
            "ASTRA_EMU_MUSICA_MOUNT_BINDING",
...
fn musica_vm_event_name(event: Option<&MusicaVmEvent>) -> &'static str {
    match event {
        Some(MusicaVmEvent::Wait(_)) => "wait",
        Some(MusicaVmEvent::Message { .. }) => "message",
        Some(MusicaVmEvent::Audio { .. }) => "audio",
        Some(MusicaVmEvent::Stage(_)) => "stage",
        Some(MusicaVmEvent::Character(_)) => "character",
        Some(MusicaVmEvent::AxisScroll(_)) => "axis_scroll",
        Some(MusicaVmEvent::LinearScroll(_)) => "linear_scroll",
        Some(MusicaVmEvent::ScrollXf(_)) => "scroll_xf",
        Some(MusicaVmEvent::WScroll2(_)) => "wscroll2",
        Some(MusicaVmEvent::Effect(_)) => "effect",
        Some(MusicaVmEvent::EffectCleared { .. }) => "effect_cleared",
        Some(MusicaVmEvent::Firefly(_)) => "firefly",
        Some(MusicaVmEvent::FireflyCleared { .. }) => "firefly_cleared",
        Some(MusicaVmEvent::SecondaryEffect(_)) => "secondary_effect",
        Some(MusicaVmEvent::SecondaryEffectCleared { .. }) => "secondary_effect_cleared",
        Some(MusicaVmEvent::ScreenShake(_)) => "screen_shake",
        Some(MusicaVmEvent::Panel { .. }) => "panel",
        Some(MusicaVmEvent::Choice { .. }) => "choice",
        Some(MusicaVmEvent::Movie(_)) => "movie",
        Some(MusicaVmEvent::Chain { .. }) => "chain",
        Some(MusicaVmEvent::Terminal) => "terminal",
        None => "none",
    }
}

fn runtime_error_code(error: &MusicaRuntimeError) -> &'static str {
    match error {
        ...
        MusicaRuntimeError::Waiting => "ASTRA_EMU_MUSICA_RUNTIME_WAIT",
        MusicaRuntimeError::Overflow => "ASTRA_EMU_MUSICA_RUNTIME_OVERFLOW",
        MusicaRuntimeError::Snapshot => "ASTRA_EMU_MUSICA_RUNTIME_SNAPSHOT",
        MusicaRuntimeError::ChainTarget => "ASTRA_EMU_MUSICA_RUNTIME_CHAIN",
        MusicaRuntimeError::AudioResource => "ASTRA_EMU_MUSICA_RUNTIME_AUDIO_RESOURCE",
        MusicaRuntimeError::Effect { .. } => "ASTRA_EMU_MUSICA_RUNTIME_EFFECT",
        MusicaRuntimeError::UnsupportedEffectKind { .. } => "ASTRA_EMU_MUSICA_RUNTIME_EFFECT_KIND",
        MusicaRuntimeError::Panel { .. } => "ASTRA_EMU_MUSICA_RUNTIME_PANEL",
        MusicaRuntimeError::Choice => "ASTRA_EMU_MUSICA_RUNTIME_CHOICE",
        MusicaRuntimeError::Firefly => "ASTRA_EMU_MUSICA_RUNTIME_FIREFLY",
        MusicaRuntimeError::SecondaryEffect => "ASTRA_EMU_MUSICA_RUNTIME_SECONDARY_EFFECT",
        MusicaRuntimeError::ScreenShake => "ASTRA_EMU_MUSICA_RUNTIME_SCREEN_SHAKE",
        MusicaRuntimeError::ScrollXf => "ASTRA_EMU_MUSICA_RUNTIME_SCROLL_XF",
        MusicaRuntimeError::WScroll2 => "ASTRA_EMU_MUSICA_RUNTIME_WSCROLL2",
        MusicaRuntimeError::Character => "ASTRA_EMU_MUSICA_RUNTIME_CHARACTER",
        MusicaRuntimeError::AxisScroll => "ASTRA_EMU_MUSICA_RUNTIME_AXIS_SCROLL",
        MusicaRuntimeError::LinearScroll => "ASTRA_EMU_MUSICA_RUNTIME_LINEAR_SCROLL",
        MusicaRuntimeError::Backlog => "ASTRA_EMU_MUSICA_RUNTIME_BACKLOG",
        MusicaRuntimeError::MessageVoiceDuration => "ASTRA_EMU_MUSICA_MESSAGE_VOICE_DURATION",
        MusicaRuntimeError::MessageControl(error) => match error {
            MusicaMessageMarkupError::Truncated => "ASTRA_EMU_MUSICA_MESSAGE_CONTROL_TRUNCATED",
            MusicaMessageMarkupError::Unsupported => "ASTRA_EMU_MUSICA_MESSAGE_CONTROL_UNSUPPORTED",
            MusicaMessageMarkupError::NonCanonical => {
                "ASTRA_EMU_MUSICA_MESSAGE_CONTROL_NONCANONICAL"
            }
            MusicaMessageMarkupError::Bounds => "ASTRA_EMU_MUSICA_MESSAGE_CONTROL_BOUNDS",
            MusicaMessageMarkupError::LoadSchema => "ASTRA_EMU_MUSICA_MESSAGE_LOAD_SCHEMA",
        },
    }
}

fn session_missing() -> LegacyProviderError {
    invalid("ASTRA_EMU_MUSICA_SESSION_MISSING", "session is not active")
}
...
mod tests {
    ...
    fn provider_title_pointer_hover_and_click_follow_original_menu() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                (
                    "musica:/scr/test.sc".into(),
                    b".wait 20\r\n.end\r\n".to_vec(),
                ),
                ("musica:/sys/topMenu0.png".into(), encode_stage(0)),
                ("musica:/sys/topMenu0Over.png".into(), encode_stage(255)),
            ]),
        }));
        let ctx = context();
        let session = provider
            .open(
                ...
                LegacyOpenRequest {
                    ...
                    script_uri: "musica:/scr/test.sc".into(),
        ...
        let hover = provider
            .step(
                ...
                LegacyStepInput {
                    input_edges: vec![
                        LegacyInputEdge {
                            control: MUSICA_POINTER_X.into(),
                            pressed: false,
                            value: 1_174.0,
                            sequence: 1,
                        },
                        LegacyInputEdge {
                            control: MUSICA_POINTER_Y.into(),
                            pressed: false,
                            value: 47.0,
                            sequence: 2,
                        },
            ...
            .step(
                ...
                LegacyStepInput {
                    input_edges: vec![LegacyInputEdge {
                        control: MUSICA_POINTER_PRIMARY.into(),
                        pressed: true,
                        value: 1.0,
                        sequence: 1,
                    }],
    ...
    #[test]
    fn resource_descriptor_reads_musica_ani_dimensions_without_generic_image_fallback() {
        ...
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([("musica:/st/frame.ani".into(), ani)]),
        });

        let resource = read_texture_resource(&vfs, "mount.test", "musica:/st/frame.ani", 7)
    ...
    fn layer_texture_decode_uses_the_family_provider_for_ani() {
        ...
        let resource = LegacyTextureResourceV1 {
            texture_id: 1,
            resource_uri: "musica:/st/frame.ani".into(),
            codec: "ani".into(),
            revision: texture_binding_revision("musica:/st/frame.ani", revision),
            decoded_width: 2,
            decoded_height: 1,
            decoded_format: LegacyTextureFormat::Rgba8,
        };
    ...
    fn gallery_pages_resolve_only_verified_system_assets() {
        assert_eq!(
            gallery_resource_uri(MusicaSystemPage::GalleryCg, 0).unwrap(),
            "musica:/sys/cgpage001.png"
        );
        assert_eq!(
            gallery_resource_uri(MusicaSystemPage::GalleryCg, 11).unwrap(),
            "musica:/sys/cgpage012.png"
        );
        assert_eq!(
            gallery_resource_uri(MusicaSystemPage::GalleryBgm, 32).unwrap(),
            "musica:/sys/musicPage3.png"
        );
        assert_eq!(
            gallery_resource_uri(MusicaSystemPage::GalleryReplay, 3).unwrap(),
            "musica:/sys/flash3.png"
        );
        assert!(gallery_resource_uri(MusicaSystemPage::GalleryCg, 12).is_err());
        assert!(gallery_resource_uri(MusicaSystemPage::GalleryBgm, 47).is_err());
        assert!(gallery_resource_uri(MusicaSystemPage::GalleryReplay, 4).is_err());
    }

    #[test]
    fn leaving_bgm_gallery_stops_the_shared_stream_before_returning_to_memories() {
        let script = parse_sc(b".end\r\n", &ScOpcodeCatalog::observed_musica()).unwrap();
        ...
        vm.set_system_page(MusicaSystemPage::GalleryBgm, 0).unwrap();
        vm.gallery_bgm_play("musica:/bgm/BGM001.ogg").unwrap();
        ...
        .unwrap();
        assert_eq!(action, MusicaSystemUiAction::GalleryBgmStop);
        assert_eq!(vm.state().system_ui.page, MusicaSystemPage::Memories);
        let stop = vm.gallery_bgm_stop().unwrap();
        assert!(matches!(
            stop.as_slice(),
            [MusicaAudioCommand::Stop {
                stream_id: crate::runtime::MUSICA_BGM_STREAM_ID,
                ..
            }]
        ));
    }
    ...
    fn script_loader_expands_bounded_includes_and_rejects_cycles() {
        let reader: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                (
                    "musica:/scr/root.sc".into(),
                    b".include part.sc\r\n.end\r\n".to_vec(),
                ),
                (
                    "musica:/scr/part.sc".into(),
                    b".set included = 1\r\n".to_vec(),
                ),
            ]),
        });
        ...
        let cycle_reader: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/a.sc".into(), b".include b.sc\r\n".to_vec()),
        ...
        let session = provider
            .open(
                ...
                LegacyOpenRequest {
                    ...
                    case_fingerprint: Hash256::from_sha256(b"case"),
                    script_uri: "musica:/scr/root.sc".into(),
                    fixed_delta_ns: 16_666_667,
                    session_seed: 7,
                    compatibility_profile: "musica.reference".into(),
    ...
    fn full_script_resource_audit_is_bounded_and_fails_on_missing_assets() {
        let reader: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ...
                ("musica:/bg/bg.png".into(), vec![1]),
                ("musica:/bgm/theme.ogg".into(), vec![2]),
    ...
    fn save_slot_round_trips_through_v9_writable_file_port() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::clone(&vfs));
        let ctx = context();
    ...
    fn load_page_escape_returns_to_its_actual_owner() {
        ...
        assert_eq!(
            ...
            MusicaSystemUiAction::CloseGameplaySystemPage
        );
        assert_eq!(gameplay.state().system_ui.page, MusicaSystemPage::Load);

        let mut title = MusicaVm::new(
            "musica:/scr/test.sc".into(),
        ...
        title.set_system_page(MusicaSystemPage::Load, 0).unwrap();
        assert_eq!(
            apply_system_ui_input(&mut title, &escape).unwrap(),
            MusicaSystemUiAction::Present
        );
        assert_eq!(title.state().system_ui.page, MusicaSystemPage::Title);
    }
    ...
    fn typed_system_menu_publishes_original_commands_before_save_selection() {
        ...
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ...
                (
                    "musica:/sys/saveloadBase.png".into(),
                    encode_rgba(1280, 720),
                ),
                ("musica:/sys/saveloadSave.png".into(), encode_rgba(352, 48)),
                (
                    "musica:/sys/saveloadSelect.png".into(),
                    encode_rgba(344, 98),
                ),
                (
                    "musica:/sys/saveloadButtons.png".into(),
                    encode_rgba(356, 48),
                ),
                (
                    "musica:/sys/saveload_Page0.png".into(),
                    encode_rgba(208, 48),
                ),
                (
                    "musica:/sys/saveload_Page1.png".into(),
                    encode_rgba(208, 48),
                ),
                (
                    "musica:/sys/saveload_Page2.png".into(),
                    encode_rgba(208, 48),
                ),
                ("musica:/sys/notsaved.png".into(), encode_rgba(106, 60)),
            ]),
        });
        ...
        let mut provider = MusicaRuntimeProvider::with_host_services(services);
        let ctx = context();
        let session = provider
            .open(
                &ctx,
        ...
        assert!(output.live.resource_scenes.iter().any(|scene| {
            scene
                ...
                .texture_resources
                .iter()
                .any(|resource| resource.resource_uri == "musica:/sys/saveloadBase.png")
        }));
        ...
        assert!(prompt
            .prompt_id
            .starts_with("musica.text_input.save_comment.20."));
    ...
    fn quick_save_rotates_page1_slots_and_skips_unchanged_lines() {
        ...
        eprintln!(
            ...
            provider.sessions[&session.0].quick_save_cursor, initial_pc_line
        );
        assert!(writable
            .files
            .lock()
    ...
    fn config_fullscreen_uses_host_command_before_resuming_gameplay() {
        ...
        // from the same stable wait that the native menu uses.
        {
            ...
            assert_eq!(
                session_state
                    .vm
                    .apply_config_control(MusicaConfigControl::Fullscreen(true))
                    .unwrap(),
    ...
    fn exit_confirmation_cancels_without_consuming_gameplay_then_accepts_once() {
        ...
        let select_exit = |provider: &mut MusicaRuntimeProvider, tick: u64, menu_id: String| {
            provider
                .step(
                    &ctx,
                    &session,
        ...
        let open_menu = |provider: &mut MusicaRuntimeProvider, tick: u64| {
            provider
                .step(
                    &ctx,
                    &session,
    ...
    fn confirmation_messages_match_original_ascii_question_marks() {
        assert_eq!(
            musica_confirmation_message(MusicaConfirmationAction::Exit),
            "終了してもよろしいですか?"
        );
        assert_eq!(
            musica_confirmation_message(MusicaConfirmationAction::ReturnTitle),
            "ゲームを中断してメニューに戻ります。よろしいですか?"
        );
    }
    ...
    fn title_exit_terminates_directly_without_confirmation_transaction() {
        ...
        let services = LegacyFamilyHostServicesV9 {
            vfs: Arc::new(MemoryReader {
                scripts: BTreeMap::from([
                    ("musica:/scr/test.sc".into(), b".end\r\n".to_vec()),
                    ("musica:/sys/topMenu0.png".into(), title_png),
                ]),
            }),
            surfaces: Arc::new(RecordingSurfaceHost::default()),
            hooks: Arc::new(UnboundHookHost),
    ...
    fn host_window_close_publishes_family_confirmation_before_exit() {
        ...
        let confirmation_id = confirmations
            ...
            .confirmation_id
            .clone();
        assert!(confirmation_id.starts_with("musica.confirmation.window_close."));
        let accepted = provider
            .step(
                &ctx,
                &session,
    ...
    fn save_load_page_uses_the_verified_assets_and_slot_grid() {
        ...
        .unwrap();
        vm.begin_title_launch().unwrap();
        vm.set_system_page(MusicaSystemPage::Save, 0).unwrap();
        ...
        assert_eq!(
            ...
            "musica:/sys/saveloadSave.png"
        );
        assert!(frame.draws.iter().any(|draw| {
            draw.texture_id == MUSICA_SYSTEM_TEXTURE_ID + 1
                && draw.vertices[0].position
                    == [
                        MUSICA_SAVE_LOAD_TITLE_X as f32,
                        MUSICA_SAVE_LOAD_HEADER_Y as f32,
                    ]
        }));
        assert!(frame.draws.iter().any(|draw| {
            draw.texture_id == MUSICA_SYSTEM_TEXTURE_ID + 3
                && draw.vertices[0].position
                    == [
                        MUSICA_SAVE_LOAD_PAGE_X as f32,
                        MUSICA_SAVE_LOAD_HEADER_Y as f32,
                    ]
        }));
        assert!(frame.draws.iter().any(|draw| {
            draw.texture_id == MUSICA_SYSTEM_TEXTURE_ID + 2
                && draw.vertices[0].position == [64.0, 81.0]
        }));
        vm.set_system_page(MusicaSystemPage::Save, 20).unwrap();
        ...
        assert_eq!(
            ...
            "musica:/sys/saveload_Page2.png"
        );
        assert!(manual_frame.draws.iter().any(|draw| {
            draw.texture_id == MUSICA_SYSTEM_TEXTURE_ID + 4
                && draw.scissor
                    == Some(LegacyScissorV1 {
                        x: 578,
                        y: 656,
    ...
    fn v9_resource_scene_writes_exclusive_host_surfaces_and_multilayer_transaction() {
        ...
        PngEncoder::new(&mut png)
            ...
            .unwrap();
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([("musica:/bg/test.png".into(), png)]),
        });
        let resource = read_texture_resource(&vfs, "mount.test", "musica:/bg/test.png", 1).unwrap();
        let mut draws = Vec::new();
        ...
        let background = commits
            .iter()
            .find(|commit| commit.surface_id == "musica.surface.background")
            .unwrap();
        ...
        for commit in commits
            .iter()
            .filter(|commit| commit.surface_id != "musica.surface.background")
        {
    ...
    fn provider_lifecycle_wait_snapshot_restore_and_shutdown() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([("musica:/scr/test.sc".into(), script)]),
        }));
        let ctx = context();
        let session = provider
            .open(
        ...
        assert!(first.control.blackboard.iter().any(|mutation| {
            mutation.key == "musica.gallery_unlock_count" && mutation.value == "1"
        }));
    ...
    fn global_progress_is_loaded_before_a_fresh_session_executes_script() {
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                (
                    "musica:/scr/unlock.sc".into(),
                    b".setglobal REN_CLEAR = 1\r\n.end\r\n".to_vec(),
                ),
                (
                    "musica:/scr/load.sc".into(),
        ...
        let storage_options = BTreeMap::from([(
            MUSICA_GLOBAL_PROGRESS_OPTION.into(),
            MUSICA_WRITABLE_FILE_BINDING_ID.into(),
        )]);
        let ctx = context();

        let mut first_provider = MusicaRuntimeProvider::with_host_services(services());
        let first_session = first_provider
            .open(
                ...
                LegacyOpenRequest {
                    ...
                    case_fingerprint: Hash256::from_sha256(b"case"),
                    script_uri: "musica:/scr/unlock.sc".into(),
                    fixed_delta_ns: 16_666_667,
                    session_seed: 7,
                    compatibility_profile: "musica.reference".into(),
        ...
        assert!(writable
            ...
            .lock()
            .unwrap()
            .contains_key(MUSICA_GLOBAL_PROGRESS_PATH));
        first_provider.shutdown(&ctx, &first_session).unwrap();

        let mut second_provider = MusicaRuntimeProvider::with_host_services(services());
        let second_session = second_provider
            .open(
                ...
                LegacyOpenRequest {
                    ...
                    case_fingerprint: Hash256::from_sha256(b"case"),
                    script_uri: "musica:/scr/load.sc".into(),
                    fixed_delta_ns: 16_666_667,
                    session_seed: 7,
                    compatibility_profile: "musica.reference".into(),
    ...
    fn persistent_config_round_trip_is_identity_bound_and_bounded() {
        ...
        let config = MusicaConfigState {
            bgm_volume: 37,
            text_shadow: false,
            ..MusicaConfigState::default()
        };
        let envelope = MusicaConfigEnvelope {
            schema: MUSICA_CONFIG_SCHEMA.into(),
            case_fingerprint,
    ...
    fn persistent_config_rejects_an_out_of_range_quick_save_cursor() {
        ...
        let envelope = MusicaConfigEnvelope {
            ...
            package_hash,
            profile_fingerprint,
            config: MusicaConfigState::default(),
            quick_save_cursor: MUSICA_QUICK_SAVE_SLOT_COUNT,
        };
        let payload = encode_config(&envelope).unwrap();
        writable
            .execute(
    ...
    fn persistent_config_store_is_atomic_and_skips_unchanged_values() {
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([("musica:/scr/test.sc".into(), b".end\r\n".to_vec())]),
        }));
        let ctx = context();
        let session_id = provider
            .open(
        ...
        let (case_fingerprint, package_hash, profile_fingerprint, config) = {
            ...
            session
                .vm
                .apply_config_control(MusicaConfigControl::BgmVolume(37))
                .unwrap();
            session
                .vm
                .apply_config_control(MusicaConfigControl::ToggleTextShadow)
                .unwrap();
            session
                .vm
                .apply_config_control(MusicaConfigControl::Apply)
                .unwrap();
        ...
        let payload = encode_config(&MusicaConfigEnvelope {
            schema: MUSICA_CONFIG_SCHEMA.into(),
            case_fingerprint,
            package_hash,
            profile_fingerprint,
    ...
    fn provider_title_launch_uses_verified_system_assets_and_restores_page_state() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), b".end\r\n".to_vec()),
                ("musica:/sys/topMenu0.png".into(), page_png.clone()),
                ("musica:/sys/configBase.png".into(), page_png.clone()),
                ("musica:/sys/knob.png".into(), encode_rgba(15, 25)),
                ("musica:/sys/checkmark.png".into(), encode_rgba(21, 32)),
                ("musica:/sys/circle.png".into(), encode_rgba(74, 74)),
                (
                    "musica:/sys/BGMTest.wav".into(),
                    b"RIFF\x04\0\0\0WAVE".to_vec(),
                ),
                ("musica:/sys/saveloadBase.png".into(), page_png),
            ]),
        }));
        let ctx = context();
        let session = provider
        ...
        assert!(title
            ...
            .blackboard
            .iter()
            .any(|mutation| { mutation.key == "musica.system_page" && mutation.value == "title" }));
        assert!(title.control.blackboard.iter().any(|mutation| {
            mutation.key == LEGACY_SYSTEM_UI_ACTIVE_BLACKBOARD_KEY && mutation.value == "true"
        }));
        assert!(title.control.blackboard.iter().any(|mutation| {
            mutation.key == "musica.gallery_unlock_count" && mutation.value == "0"
        }));
        assert!(title.control.blackboard.iter().any(|mutation| {
            mutation.key == "musica.choice_active" && mutation.value == "false"
        }));
        assert!(title
            .control
            .blackboard
            .iter()
            .any(|mutation| { mutation.key == "musica.play_mode" && mutation.value == "normal" }));
        assert_eq!(
            title.live.resource_scenes[0].value.texture_resources[0].resource_uri,
            "musica:/sys/topMenu0.png"
        );
        ...
        assert!(matches!(
            ...
            ] if resource_uri == "musica:/sys/BGMTest.wav"
        ));
        provider
            .step(
                &ctx,
        ...
        assert!(returned_to_title
            ...
            .any(|mutation| { mutation.key == "musica.play_mode" && mutation.value == "normal" }));
        assert!(returned_to_title.control.blackboard.iter().any(|mutation| {
            mutation.key == "musica.route_complete" && mutation.value == "true"
        }));
    ...
    fn config_hit_map_clamps_sliders_and_preserves_original_action_regions() {
        assert_eq!(
            ...
            Some(MusicaConfigControl::MessageSpeedUnread(0))
        );
        assert_eq!(
            config_control_at(151, 160),
            Some(MusicaConfigControl::MessageSpeedUnread(50))
        );
        assert_eq!(
            config_control_at(259, 160),
            Some(MusicaConfigControl::MessageSpeedUnread(100))
        );
        assert_eq!(
            config_control_at(700, 130),
            Some(MusicaConfigControl::ToggleBgmMute)
        );
        assert_eq!(
            config_control_at(750, 205),
            Some(MusicaConfigControl::TestAudio(MusicaConfigAudioBus::Voice))
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Some(MusicaConfigControl::PreferredPlayMode(MusicaPlayMode::Auto))
        );
        assert_eq!(
            config_control_at(200, 600),
            Some(MusicaConfigControl::PreferredPlayMode(MusicaPlayMode::Skip))
        );
        assert_eq!(
            config_control_at(250, 500),
            Some(MusicaConfigControl::FontPrevious)
        );
    ...
    fn config_text_shadow_uses_the_existing_typed_outline_without_a_renderer_fallback() {
        let enabled = musica_message_presentation(Some((1280, 720)), true).unwrap();
        assert_eq!(
            enabled.outline,
        ...
        let disabled = musica_message_presentation(Some((1280, 720)), false).unwrap();
    ...
    fn auto_menu_rebinds_the_active_message_wait_without_a_manual_advance() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), source.to_vec()),
                ("musica:/sys/topMenu0.png".into(), page_png),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn config_volume_and_mute_are_applied_at_the_shared_audio_boundary() {
        ...
        .unwrap();
        let mut state = MusicaVm::decode_snapshot(&vm.snapshot_bytes().unwrap()).unwrap();
        state.system_ui.config.bgm_volume = 40;
        state.audio.insert(
            0,
            crate::MusicaAudioState {
                bus: "bgm".into(),
                encoding: MusicaAudioEncoding::Ogg,
                resource_uri: "musica:/bgm/test.ogg".into(),
                looped: true,
                volume_milli: 500,
                pan_milli: 0,
                playing: true,
        ...
        state.audio.insert(
            ...
            crate::MusicaAudioState {
                bus: "se2".into(),
                encoding: MusicaAudioEncoding::Ogg,
                resource_uri: "musica:/se/test.ogg".into(),
                looped: true,
                volume_milli: 800,
                pan_milli: 0,
                playing: true,
    ...
    fn provider_exposes_original_memories_order_only_for_the_verified_title_variant() {
        ...
        let mut resources = BTreeMap::from([
            ("musica:/scr/test.sc".into(), b".end\r\n".to_vec()),
            (
                "musica:/scr/fb_ren_04.sc".into(),
                b".transition 0 * 15\r\n.stage * WHITE.png 0 0\r\n.playBGM * * 5\r\n.transition 0 * 5\r\n.stage * WHITE.png 0 0\r\n.wait 100\r\n.transition 0 * 10\r\n.stage * WHITE.png 0 0\r\n.end\r\n".to_vec(),
            ),
            ("musica:/bg/WHITE.png".into(), page_png.clone()),
            ("musica:/sys/topMenu2.png".into(), page_png.clone()),
            ("musica:/sys/memories.png".into(), page_png.clone()),
            ("musica:/sys/cgmode0.png".into(), page_png.clone()),
            ("musica:/sys/cgmode0box.png".into(), page_png.clone()),
            ("musica:/sys/cgmode0menu.png".into(), label_png.clone()),
            ("musica:/sys/flash0.png".into(), page_png.clone()),
            ("musica:/sys/flash0menu.png".into(), menu_png),
            ("musica:/sys/musicPage1.png".into(), page_png),
            ("musica:/sys/musicNote.png".into(), note_png),
        ]);
        for index in 1..=12 {
            resources.insert(
                format!("musica:/sys/cgpage{index:03}.png"),
                label_png.clone(),
            );
        }
        let mut provider =
            MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader { scripts: resources }));
        let ctx = context();
        let session = provider
            .open(
                &ctx,
    ...
    fn provider_title_session_naturally_chains_all_verified_routes() {
        ...
        let mut resources = BTreeMap::from([
            ("musica:/scr/K06_01.sc".into(), choice_source.to_vec()),
            ("musica:/sys/topMenu0.png".into(), title_png.clone()),
            ("musica:/sys/topMenu1.png".into(), title_png.clone()),
            ("musica:/sys/topMenu2.png".into(), title_png),
            (MUSICA_CHOICE_RESOURCE_URIS[0].into(), choice_png.clone()),
            (MUSICA_CHOICE_RESOURCE_URIS[1].into(), choice_png.clone()),
            (MUSICA_CHOICE_RESOURCE_URIS[2].into(), choice_png),
        ]);
        for (script_name, flag, _) in routes {
            resources.insert(
                format!("musica:/scr/{script_name}"),
        ...
        let session = provider
            .open(
                ...
                LegacyOpenRequest {
                    ...
                    case_fingerprint: Hash256::from_sha256(b"case"),
                    script_uri: "musica:/scr/K06_01.sc".into(),
                    fixed_delta_ns: 16_666_667,
                    session_seed: 7,
                    compatibility_profile: "musica.reference".into(),
                    family_options: BTreeMap::from([
    ...
    fn provider_completes_movie_gallery_script_through_media_fence() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), b".end\r\n".to_vec()),
                ("musica:/scr/fb_aya_12.sc".into(), movie_script),
                ("musica:/sys/topMenu2.png".into(), page_png.clone()),
                ("musica:/sys/memories.png".into(), page_png),
                (
                    "musica:/mov/ed_ayame.avi".into(),
    ...
    fn provider_tail_chains_and_restores_the_active_script_identity() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), entry),
                ("musica:/scr/K01.sc".into(), next),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_resumes_a_movie_into_a_chain_and_publishes_the_next_message_wait() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), entry),
                ("musica:/scr/K01.sc".into(), next),
                ("musica:/mov/op.avi".into(), b"RIFFfixture".to_vec()),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_exposes_message_plaintext_only_through_a_one_shot_lease() {
        ...
        assert_eq!(lease.source_ref, "musica.sc.message");
        let presentation = &presentation.value.presentation;
        assert_eq!(presentation.layout_id, "musica.message");
        ...
        assert_eq!(restored.live.text[0].source_ref, "musica.sc.message.resume");
    ...
    fn provider_game_menu_click_toggles_auto_without_advancing_as_message_click() {
        ...
        assert!(output
            ...
            .blackboard
            .iter()
            .any(|mutation| { mutation.key == "musica.play_mode" && mutation.value == "auto" }));
    }
    ...
    fn eligible_control_is_owned_by_the_active_host_message_wait() {
        ...
        let pressed = provider
            .step(
                ...
                LegacyStepInput {
                    input_edges: vec![LegacyInputEdge {
                        control: MUSICA_CONTROL_KEY.into(),
                        pressed: true,
                        value: 1.0,
                        sequence: 1,
                    }],
    ...
    fn provider_suspends_message_wait_for_verified_backlog_wheel_navigation() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/sys/msgPanel.png".into(), panel_png),
                ("musica:/sys/backlogGauge.png".into(), gauge_png),
                ("musica:/sys/ball.png".into(), ball_png),
                ("musica:/voice/voice".into(), b"OggSfixture".to_vec()),
            ]),
        }));
        let ctx = context();
        let session = provider
        ...
        assert_eq!(backlog.live.text[0].source_ref, "musica.sc.backlog");
        ...
        assert!(matches!(
            ...
            ] if resource_uri == "musica:/voice/voice" && *volume == 0.5 && *pan == -0.25
        ));
        assert_eq!(
            provider.sessions[&session.0].vm.state().wait,
            wait_before_replay
        ...
        assert_eq!(resumed.live.text[0].source_ref, "musica.sc.message.resume");
    }
    ...
    fn provider_moves_and_commits_choice_from_canonical_key_edges() {
        assert_eq!(MUSICA_CHOICE_RESOURCE_URIS[0], "musica:/sys/SelectBLur.png");
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ...
                (MUSICA_CHOICE_RESOURCE_URIS[0].into(), choice_png.clone()),
                (MUSICA_CHOICE_RESOURCE_URIS[1].into(), choice_png.clone()),
                (MUSICA_CHOICE_RESOURCE_URIS[2].into(), choice_png.clone()),
                ("musica:/st/CH.png".into(), choice_png),
            ]),
        }));
        let ctx = context();
        let session = provider
        ...
        assert_eq!(first.status, LegacyRuntimeStatus::Awaiting);
        assert!(first.control.blackboard.iter().any(|mutation| {
            mutation.key == "musica.choice_active" && mutation.value == "true"
        }));
        assert!(matches!(
            first.control.waits.as_slice(),
        ...
        let first_presentation = first
            ...
            .events
            .iter()
            .find(|event| event.event == MUSICA_CHOICE_PRESENTATION_SCHEMA)
        ...
        assert!(texture_ids.contains(&(MUSICA_CHARACTER_TEXTURE_BASE + 100)));
        assert!(texture_ids.contains(&MUSICA_CHOICE_TEXTURE_BASE));
    ...
    fn movie_restore_rejects_non_zero_continuation_without_a_v9_seek_field() {
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([("musica:/mov/op.avi".into(), b"RIFFfixture".to_vec())]),
        });
        let movie = MusicaMovieState {
            media_id: "musica.movie.1".into(),
            resource_uri: "musica:/mov/op.avi".into(),
            width: 1280,
            height: 720,
            skippable: true,
            continuation_pts: 1,
            fence_id: "musica.wait.movie.1".into(),
        };
        let error =
    ...
    fn provider_validates_and_emits_bgm_through_the_shared_audio_contract() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/bgm/theme.ogg".into(), b"OggSfixture".to_vec()),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_centers_and_bottom_anchors_verified_static_png_stands() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/bg/BG.png".into(), background),
                ("musica:/st/STAND.png".into(), stand),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_composes_signed_character_slots_with_native_anchor_and_orientation() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/bg/BG.png".into(), background),
                ("musica:/st/CH.png".into(), character),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_crossfades_both_native_character_nodes_for_inline_load() {
        ...
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/st/Old.png".into(), png([255, 0, 0, 255])),
                ("musica:/st/New.png".into(), png([0, 255, 0, 255])),
            ]),
        });
        let characters = BTreeMap::from([(
            ...
            MusicaCharacterState {
                ...
                resource_uris: vec!["musica:/st/Old.png".into()],
                anchor_position: [640, 0],
                visible: true,
                opacity_256: 128,
                transition: None,
                replacement: Some(MusicaCharacterReplacementState {
                    resource_uri: "musica:/st/New.png".into(),
        ...
        let current = draws
            .iter()
            .find(|draw| draw.texture_id == MUSICA_CHARACTER_TEXTURE_BASE + 11)
            .unwrap();
        let replacement = draws
            .iter()
            .find(|draw| draw.texture_id == MUSICA_CHARACTER_REPLACEMENT_TEXTURE_BASE + 11)
            .unwrap();
    ...
    fn provider_stage_frames_commit_new_slots_then_retire_unmarked_previous_slots() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/bg/BG.png".into(), png([0, 0, 0, 255])),
                ("musica:/bg/BG2.png".into(), png([1, 1, 1, 255])),
                ("musica:/bg/BG3.png".into(), png([2, 2, 2, 255])),
                ("musica:/st/CH1.png".into(), png([3, 3, 3, 255])),
                ("musica:/st/CH2.png".into(), png([4, 4, 4, 255])),
            ]),
        }));
        let ctx = context();
        let session = provider
        ...
        assert!(retained_frame
            .texture_resources
            .iter()
            .any(|resource| resource.texture_id == MUSICA_CHARACTER_TEXTURE_BASE + 11));
        assert!(retained_frame
            .texture_resources
            .iter()
            .any(|resource| resource.texture_id == MUSICA_CHARACTER_TEXTURE_BASE + 12));
        ...
        assert!(discarded_frame
            .texture_resources
            .iter()
            .all(|resource| resource.texture_id < MUSICA_CHARACTER_TEXTURE_BASE));
    }
    ...
    fn scroll_xf_clips_translates_and_remaps_stage_draws() {
        ...
        let scroll = crate::MusicaScrollXfState {
            start_extent: [2, 2],
            end_extent: [2, 2],
            start_offset: [1, 0],
            end_offset: [1, 0],
    ...
    fn wscroll2_validates_sync_and_wraps_far_and_near_panoramas() {
        ...
        let mut frame = LegacyRenderResourceFrameV1 {
            ...
            texture_resources: vec![
                resource(0, "musica:/bg/far.png"),
                resource(1, "musica:/st/near.png"),
            ],
            draws: vec![draw(0), draw(1)],
        };
        let vfs: Arc<dyn LegacyVfsReader> = Arc::new(MemoryReader {
            scripts: BTreeMap::from([(
                "musica:/st/walk.txt".into(),
                b"13\r\n16\r\n19\r\n".to_vec(),
            )]),
        });
        let scroll = crate::MusicaWScroll2State {
            sync_resource_uri: "musica:/st/walk.txt".into(),
            period_ticks: 60,
            speed_tenths: -8,
    ...
    fn provider_emits_bounded_firefly_resources_and_particle_draws() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/sys/Firefly_cS.png".into(), png.clone()),
                ("musica:/sys/Firefly_cM.png".into(), png.clone()),
                ("musica:/sys/Firefly_cL.png".into(), png),
            ]),
        }));
        let ctx = context();
        let session = provider
        ...
        assert_eq!(
            frame
                ...
                .collect::<Vec<_>>(),
            [
                "musica:/sys/Firefly_cS.png",
                "musica:/sys/Firefly_cM.png",
                "musica:/sys/Firefly_cL.png",
            ]
        );
    ...
    fn provider_composes_bounded_snow_h_as_the_secondary_slot() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/sys/snowS.png".into(), png.clone()),
                ("musica:/sys/snowM.png".into(), png.clone()),
                ("musica:/sys/snowL.png".into(), png),
            ]),
        }));
        let ctx = context();
        let session = provider
    ...
    fn provider_stage_presentation_retains_active_message_panel() {
        ...
        let mut provider = MusicaRuntimeProvider::with_vfs(Arc::new(MemoryReader {
            scripts: BTreeMap::from([
                ("musica:/scr/test.sc".into(), script),
                ("musica:/bg/BG.png".into(), background_png),
                ("musica:/sys/msgPanel.png".into(), panel_png),
            ]),
        }));
        let ctx = context();
        ...
        assert!(frame
            .texture_resources
            .iter()
            .any(|resource| resource.resource_uri == "musica:/sys/msgPanel.png"));
