...
| Player Automation Testing | `player-automation-testing.md`, `samples-and-test-matrix.md` | `astra test`, `astra.test.player_plan.v1`, `astra.test.player_report.v1`, RuntimeEvent injection | TODO 18 | NativeVN player plans, CTest |
...
| Player automation tests | `astra test` over `Samples/NativeVN/Tests/player/nativevn_player.yaml`, JSON Pointer assertions, explicit RuntimeEvent injection, negative CTest cases |
